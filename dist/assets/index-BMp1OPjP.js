...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:En,depthTest:!1,depthWrite:!1})}function Mo(){return new An({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Aa(),fragmentShader:`
...
`)+`
`+u);const b=w+p+a,T=w+u+o,F=Co(r,r.VERTEX_SHADER,b),D=Co(r,r.FRAGMENT_SHADER,T);r.attachShader(x,F),r.attachShader(x,D),e.index0AttributeName!==void 0?r.bindAttribLocation(x,0,e.index0AttributeName):e.morphTargets===!0&&r.bindAttribLocation(x,0,"position"),r.linkProgram(x);function R(C){if(i.debug.checkShaderErrors){const Z=r.getProgramInfoLog(x).trim(),W=r.getShaderInfoLog(F).trim(),J=r.getShaderInfoLog(D).trim();let tt=!0,K=!0;if(r.getProgramParameter(x,r.LINK_STATUS)===!1)if(tt=!1,typeof i.debug.onShaderError=="function")i.debug.onShaderError(r,x,F,D);else{const et=Do(r,F,"vertex"),y=Do(r,D,"fragment");console.error("THREE.WebGLProgram: Shader Error "+r.getError()+" - VALIDATE_STATUS "+r.getProgramParameter(x,r.VALIDATE_STATUS)+`
...
}`;function Yp(i,t,e){let n=new gc;const r=new qt,s=new qt,a=new le,o=new gu({depthPacking:dl}),c=new vu,l={},h=e.maxTextureSize,f={[Tn]:we,[we]:Tn,[Je]:Je},d=new An({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new qt},radius:{value:4}},vertexShader:Xp,fragmentShader:qp}),m=d.clone();m.defines.HORIZONTAL_PASS=1;const g=new se;g.setAttribute("position",new Le(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const x=new Ye(g,d),p=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=qo;let u=this.type;this.render=function(D,R,O){if(p.enabled===!1||p.autoUpdate===!1&&p.needsUpdate===!1||D.length===0)return;const E=i.getRenderTarget(),M=i.getActiveCubeFace(),C=i.getActiveMipmapLevel(),Z=i.state;Z.setBlending(En),Z.buffers.color.setClear(1,1,1,1),Z.buffers.depth.setTest(!0),Z.setScissorTest(!1);const W=u!==on&&this.type===on,J=u===on&&this.type!==on;for(let tt=0,K=D.length;tt<K;tt++){const et=D[tt],y=et.shadow;if(y===void 0){console.warn("THREE.WebGLShadowMap:",et,"has no shadow.");continue}if(y.autoUpdate===!1&&y.needsUpdate===!1)continue;r.copy(y.mapSize);const B=y.getFrameExtents();if(r.multiply(B),s.copy(y.mapSize),(r.x>h||r.y>h)&&(r.x>h&&(s.x=Math.floor(h/B.x),r.x=s.x*B.x,y.mapSize.x=s.x),r.y>h&&(s.y=Math.floor(h/B.y),r.y=s.y*B.y,y.mapSize.y=s.y)),y.map===null||W===!0||J===!0){const it=this.type!==on?{minFilter:Ze,magFilter:Ze}:{};y.map!==null&&y.map.dispose(),y.map=new Wn(r.x,r.y,it),y.map.texture.name=et.name+".shadowMap",y.camera.updateProjectionMatrix()}i.setRenderTarget(y.map),i.clear();const z=y.getViewportCount();for(let it=0;it<z;it++){const ht=y.getViewport(it);a.set(s.x*ht.x,s.y*ht.y,s.x*ht.z,s.y*ht.w),Z.viewport(a),y.updateMatrices(et,it),n=y.getFrustum(),T(R,O,y.camera,et,this.type)}y.isPointLightShadow!==!0&&this.type===on&&w(y,O),y.needsUpdate=!1}u=this.type,p.needsUpdate=!1,i.setRenderTarget(E,M,C)};function w(D,R){const O=t.update(x);d.defines.VSM_SAMPLES!==D.blurSamples&&(d.defines.VSM_SAMPLES=D.blurSamples,m.defines.VSM_SAMPLES=D.blurSamples,d.needsUpdate=!0,m.needsUpdate=!0),D.mapPass===null&&(D.mapPass=new Wn(r.x,r.y)),d.uniforms.shadow_pass.value=D.map.texture,d.uniforms.resolution.value=D.mapSize,d.uniforms.radius.value=D.radius,i.setRenderTarget(D.mapPass),i.clear(),i.renderBufferDirect(R,null,O,d,x,null),m.uniforms.shadow_pass.value=D.mapPass.texture,m.uniforms.resolution.value=D.mapSize,m.uniforms.radius.value=D.radius,i.setRenderTarget(D.map),i.clear(),i.renderBufferDirect(R,null,O,m,x,null)}function b(D,R,O,E){let M=null;const C=O.isPointLight===!0?D.customDistanceMaterial:D.customDepthMaterial;if(C!==void 0)M=C;else if(M=O.isPointLight===!0?c:o,i.localClippingEnabled&&R.clipShadows===!0&&Array.isArray(R.clippingPlanes)&&R.clippingPlanes.length!==0||R.displacementMap&&R.displacementScale!==0||R.alphaMap&&R.alphaTest>0||R.map&&R.alphaTest>0){const Z=M.uuid,W=R.uuid;let J=l[Z];J===void 0&&(J={},l[Z]=J);let tt=J[W];tt===void 0&&(tt=M.clone(),J[W]=tt,R.addEventListener("dispose",F)),M=tt}if(M.visible=R.visible,M.wireframe=R.wireframe,E===on?M.side=R.shadowSide!==null?R.shadowSide:R.side:M.side=R.shadowSide!==null?R.shadowSide:f[R.side],M.alphaMap=R.alphaMap,M.alphaTest=R.alphaTest,M.map=R.map,M.clipShadows=R.clipShadows,M.clippingPlanes=R.clippingPlanes,M.clipIntersection=R.clipIntersection,M.displacementMap=R.displacementMap,M.displacementScale=R.displacementScale,M.displacementBias=R.displacementBias,M.wireframeLinewidth=R.wireframeLinewidth,M.linewidth=R.linewidth,O.isPointLight===!0&&M.isMeshDistanceMaterial===!0){const Z=i.properties.get(M);Z.light=O}return M}function T(D,R,O,E,M){if(D.visible===!1)return;if(D.layers.test(R.layers)&&(D.isMesh||D.isLine||D.isPoints)&&(D.castShadow||D.receiveShadow&&M===on)&&(!D.frustumCulled||n.intersectsObject(D))){D.modelViewMatrix.multiplyMatrices(O.matrixWorldInverse,D.matrixWorld);const W=t.update(D),J=D.material;if(Array.isArray(J)){const tt=W.groups;for(let K=0,et=tt.length;K<et;K++){const y=tt[K],B=J[y.materialIndex];if(B&&B.visible){const z=b(D,B,E,M);D.onBeforeShadow(i,D,R,O,W,z,y),i.renderBufferDirect(O,null,W,z,D,y),D.onAfterShadow(i,D,R,O,W,z,y)}}}else if(J.visible){const tt=b(D,J,E,M);D.onBeforeShadow(i,D,R,O,W,tt,null),i.renderBufferDirect(O,null,W,tt,D,null),D.onAfterShadow(i,D,R,O,W,tt,null)}}const Z=D.children;for(let W=0,J=Z.length;W<J;W++)T(Z[W],R,O,E,M)}function F(D){D.target.removeEventListener("dispose",F);for(const O in l){const E=l[O],M=D.target.uuid;M in E&&(E[M].dispose(),delete E[M])}}}const Zp={[As]:bs,[ws]:Ps,[Rs]:Ds,[gi]:Cs,[bs]:As,[Ps]:ws,[Ds]:Rs,[Cs]:gi};function $p(i,t){function e(){let P=!1;const mt=new le;let q=null;const j=new le(0,0,0,0);return{setMask:function(Mt){q!==Mt&&!P&&(i.colorMask(Mt,Mt,Mt,Mt),q=Mt)},setLocked:function(Mt){P=Mt},setClear:function(Mt,xt,Ot,ie,fe){fe===!0&&(Mt*=ie,xt*=ie,Ot*=ie),mt.set(Mt,xt,Ot,ie),j.equals(mt)===!1&&(i.clearColor(Mt,xt,Ot,ie),j.copy(mt))},reset:function(){P=!1,q=null,j.set(-1,0,0,0)}}}function n(){let P=!1,mt=!1,q=null,j=null,Mt=null;return{setReversed:function(xt){if(mt!==xt){const Ot=t.get("EXT_clip_control");mt?Ot.clipControlEXT(Ot.LOWER_LEFT_EXT,Ot.ZERO_TO_ONE_EXT):Ot.clipControlEXT(Ot.LOWER_LEFT_EXT,Ot.NEGATIVE_ONE_TO_ONE_EXT);const ie=Mt;Mt=null,this.setClear(ie)}mt=xt},getReversed:function(){return mt},setTest:function(xt){xt?k(i.DEPTH_TEST):rt(i.DEPTH_TEST)},setMask:function(xt){q!==xt&&!P&&(i.depthMask(xt),q=xt)},setFunc:function(xt){if(mt&&(xt=Zp[xt]),j!==xt){switch(xt){case As:i.depthFunc(i.NEVER);break;case bs:i.depthFunc(i.ALWAYS);break;case ws:i.depthFunc(i.LESS);break;case gi:i.depthFunc(i.LEQUAL);break;case Rs:i.depthFunc(i.EQUAL);break;case Cs:i.depthFunc(i.GEQUAL);break;case Ps:i.depthFunc(i.GREATER);break;case Ds:i.depthFunc(i.NOTEQUAL);break;default:i.depthFunc(i.LEQUAL)}j=xt}},setLocked:function(xt){P=xt},setClear:function(xt){Mt!==xt&&(mt&&(xt=1-xt),i.clearDepth(xt),Mt=xt)},reset:function(){P=!1,q=null,j=null,Mt=null,mt=!1}}}function r(){let P=!1,mt=null,q=null,j=null,Mt=null,xt=null,Ot=null,ie=null,fe=null;return{setTest:function(Wt){P||(Wt?k(i.STENCIL_TEST):rt(i.STENCIL_TEST))},setMask:function(Wt){mt!==Wt&&!P&&(i.stencilMask(Wt),mt=Wt)},setFunc:function(Wt,Be,tn){(q!==Wt||j!==Be||Mt!==tn)&&(i.stencilFunc(Wt,Be,tn),q=Wt,j=Be,Mt=tn)},setOp:function(Wt,Be,tn){(xt!==Wt||Ot!==Be||ie!==tn)&&(i.stencilOp(Wt,Be,tn),xt=Wt,Ot=Be,ie=tn)},setLocked:function(Wt){P=Wt},setClear:function(Wt){fe!==Wt&&(i.clearStencil(Wt),fe=Wt)},reset:function(){P=!1,mt=null,q=null,j=null,Mt=null,xt=null,Ot=null,ie=null,fe=null}}}const s=new e,a=new n,o=new r,c=new WeakMap,l=new WeakMap;let h={},f={},d=new WeakMap,m=[],g=null,x=!1,p=null,u=null,w=null,b=null,T=null,F=null,D=null,R=new kt(0,0,0),O=0,E=!1,M=null,C=null,Z=null,W=null,J=null;const tt=i.getParameter(i.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let K=!1,et=0;const y=i.getParameter(i.VERSION);y.indexOf("WebGL")!==-1?(et=parseFloat(/^WebGL (\d)/.exec(y)[1]),K=et>=1):y.indexOf("OpenGL ES")!==-1&&(et=parseFloat(/^OpenGL ES (\d)/.exec(y)[1]),K=et>=2);let B=null,z={};const it=i.getParameter(i.SCISSOR_BOX),ht=i.getParameter(i.VIEWPORT),At=new le().fromArray(it),H=new le().fromArray(ht);function Q(P,mt,q,j){const Mt=new Uint8Array(4),xt=i.createTexture();i.bindTexture(P,xt),i.texParameteri(P,i.TEXTURE_MIN_FILTER,i.NEAREST),i.texParameteri(P,i.TEXTURE_MAG_FILTER,i.NEAREST);for(let Ot=0;Ot<q;Ot++)P===i.TEXTURE_3D||P===i.TEXTURE_2D_ARRAY?i.texImage3D(mt,0,i.RGBA,1,1,j,0,i.RGBA,i.UNSIGNED_BYTE,Mt):i.texImage2D(mt+Ot,0,i.RGBA,1,1,0,i.RGBA,i.UNSIGNED_BYTE,Mt);return xt}const ct={};ct[i.TEXTURE_2D]=Q(i.TEXTURE_2D,i.TEXTURE_2D,1),ct[i.TEXTURE_CUBE_MAP]=Q(i.TEXTURE_CUBE_MAP,i.TEXTURE_CUBE_MAP_POSITIVE_X,6),ct[i.TEXTURE_2D_ARRAY]=Q(i.TEXTURE_2D_ARRAY,i.TEXTURE_2D_ARRAY,1,1),ct[i.TEXTURE_3D]=Q(i.TEXTURE_3D,i.TEXTURE_3D,1,1),s.setClear(0,0,0,1),a.setClear(1),o.setClear(0),k(i.DEPTH_TEST),a.setFunc(gi),Ct(!1),It(Na),k(i.CULL_FACE),A(En);function k(P){h[P]!==!0&&(i.enable(P),h[P]=!0)}function rt(P){h[P]!==!1&&(i.disable(P),h[P]=!1)}function st(P,mt){return f[P]!==mt?(i.bindFramebuffer(P,mt),f[P]=mt,P===i.DRAW_FRAMEBUFFER&&(f[i.FRAMEBUFFER]=mt),P===i.FRAMEBUFFER&&(f[i.DRAW_FRAMEBUFFER]=mt),!0):!1}function Et(P,mt){let q=m,j=!1;if(P){q=d.get(mt),q===void 0&&(q=[],d.set(mt,q));const Mt=P.textures;if(q.length!==Mt.length||q[0]!==i.COLOR_ATTACHMENT0){for(let xt=0,Ot=Mt.length;xt<Ot;xt++)q[xt]=i.COLOR_ATTACHMENT0+xt;q.length=Mt.length,j=!0}}else q[0]!==i.BACK&&(q[0]=i.BACK,j=!0);j&&i.drawBuffers(q)}function yt(P){return g!==P?(i.useProgram(P),g=P,!0):!1}const ot={[On]:i.FUNC_ADD,[zc]:i.FUNC_SUBTRACT,[Hc]:i.FUNC_REVERSE_SUBTRACT};ot[Vc]=i.MIN,ot[Gc]=i.MAX;const Ut={[kc]:i.ZERO,[Wc]:i.ONE,[Xc]:i.SRC_COLOR,[ys]:i.SRC_ALPHA,[jc]:i.SRC_ALPHA_SATURATE,[$c]:i.DST_COLOR,[Yc]:i.DST_ALPHA,[qc]:i.ONE_MINUS_SRC_COLOR,[Ts]:i.ONE_MINUS_SRC_ALPHA,[Kc]:i.ONE_MINUS_DST_COLOR,[Zc]:i.ONE_MINUS_DST_ALPHA,[Jc]:i.CONSTANT_COLOR,[Qc]:i.ONE_MINUS_CONSTANT_COLOR,[tl]:i.CONSTANT_ALPHA,[el]:i.ONE_MINUS_CONSTANT_ALPHA};function A(P,mt,q,j,Mt,xt,Ot,ie,fe,Wt){if(P===En){x===!0&&(rt(i.BLEND),x=!1);return}if(x===!1&&(k(i.BLEND),x=!0),P!==Bc){if(P!==p||Wt!==E){if((u!==On||T!==On)&&(i.blendEquation(i.FUNC_ADD),u=On,T=On),Wt)switch(P){case pi:i.blendFuncSeparate(i.ONE,i.ONE_MINUS_SRC_ALPHA,i.ONE,i.ONE_MINUS_SRC_ALPHA);break;case re:i.blendFunc(i.ONE,i.ONE);break;case Fa:i.blendFuncSeparate(i.ZERO,i.ONE_MINUS_SRC_COLOR,i.ZERO,i.ONE);break;case Oa:i.blendFuncSeparate(i.ZERO,i.SRC_COLOR,i.ZERO,i.SRC_ALPHA);break;default:console.error("THREE.WebGLState: Invalid blending: ",P);break}else switch(P){case pi:i.blendFuncSeparate(i.SRC_ALPHA,i.ONE_MINUS_SRC_ALPHA,i.ONE,i.ONE_MINUS_SRC_ALPHA);break;case re:i.blendFunc(i.SRC_ALPHA,i.ONE);break;case Fa:i.blendFuncSeparate(i.ZERO,i.ONE_MINUS_SRC_COLOR,i.ZERO,i.ONE);break;case Oa:i.blendFunc(i.ZERO,i.SRC_COLOR);break;default:console.error("THREE.WebGLState: Invalid blending: ",P);break}w=null,b=null,F=null,D=null,R.set(0,0,0),O=0,p=P,E=Wt}return}Mt=Mt||mt,xt=xt||q,Ot=Ot||j,(mt!==u||Mt!==T)&&(i.blendEquationSeparate(ot[mt],ot[Mt]),u=mt,T=Mt),(q!==w||j!==b||xt!==F||Ot!==D)&&(i.blendFuncSeparate(Ut[q],Ut[j],Ut[xt],Ut[Ot]),w=q,b=j,F=xt,D=Ot),(ie.equals(R)===!1||fe!==O)&&(i.blendColor(ie.r,ie.g,ie.b,fe),R.copy(ie),O=fe),p=P,E=!1}function ne(P,mt){P.side===Je?rt(i.CULL_FACE):k(i.CULL_FACE);let q=P.side===we;mt&&(q=!q),Ct(q),P.blending===pi&&P.transparent===!1?A(En):A(P.blending,P.blendEquation,P.blendSrc,P.blendDst,P.blendEquationAlpha,P.blendSrcAlpha,P.blendDstAlpha,P.blendColor,P.blendAlpha,P.premultipliedAlpha),a.setFunc(P.depthFunc),a.setTest(P.depthTest),a.setMask(P.depthWrite),s.setMask(P.colorWrite);const j=P.stencilWrite;o.setTest(j),j&&(o.setMask(P.stencilWriteMask),o.setFunc(P.stencilFunc,P.stencilRef,P.stencilFuncMask),o.setOp(P.stencilFail,P.stencilZFail,P.stencilZPass)),Nt(P.polygonOffset,P.polygonOffsetFactor,P.polygonOffsetUnits),P.alphaToCoverage===!0?k(i.SAMPLE_ALPHA_TO_COVERAGE):rt(i.SAMPLE_ALPHA_TO_COVERAGE)}function Ct(P){M!==P&&(P?i.frontFace(i.CW):i.frontFace(i.CCW),M=P)}function It(P){P!==Nc?(k(i.CULL_FACE),P!==C&&(P===Na?i.cullFace(i.BACK):P===Fc?i.cullFace(i.FRONT):i.cullFace(i.FRONT_AND_BACK))):rt(i.CULL_FACE),C=P}function pt(P){P!==Z&&(K&&i.lineWidth(P),Z=P)}function Nt(P,mt,q){P?(k(i.POLYGON_OFFSET_FILL),(W!==mt||J!==q)&&(i.polygonOffset(mt,q),W=mt,J=q)):rt(i.POLYGON_OFFSET_FILL)}function ut(P){P?k(i.SCISSOR_TEST):rt(i.SCISSOR_TEST)}function S(P){P===void 0&&(P=i.TEXTURE0+tt-1),B!==P&&(i.activeTexture(P),B=P)}function _(P,mt,q){q===void 0&&(B===null?q=i.TEXTURE0+tt-1:q=B);let j=z[q];j===void 0&&(j={type:void 0,texture:void 0},z[q]=j),(j.type!==P||j.texture!==mt)&&(B!==q&&(i.activeTexture(q),B=q),i.bindTexture(P,mt||ct[P]),j.type=P,j.texture=mt)}function U(){const P=z[B];P!==void 0&&P.type!==void 0&&(i.bindTexture(P.type,null),P.type=void 0,P.texture=void 0)}function Y(){try{i.compressedTexImage2D.apply(i,arguments)}catch(P){console.error("THREE.WebGLState:",P)}}function $(){try{i.compressedTexImage3D.apply(i,arguments)}catch(P){console.error("THREE.WebGLState:",P)}}function X(){try{i.texSubImage2D.apply(i,arguments)}catch(P){console.error("THREE.WebGLState:",P)}}function ft(){try{i.texSubImage3D.apply(i,arguments)}catch(P){console.error("THREE.WebGLState:",P)}}function lt(){try{i.compressedTexSubImage2D.apply(i,arguments)}catch(P){console.error("THREE.WebGLState:",P)}}function gt(){try{i.compressedTexSubImage3D.apply(i,arguments)}catch(P){console.error("THREE.WebGLState:",P)}}function Lt(){try{i.texStorage2D.apply(i,arguments)}catch(P){console.error("THREE.WebGLState:",P)}}function nt(){try{i.texStorage3D.apply(i,arguments)}catch(P){console.error("THREE.WebGLState:",P)}}function dt(){try{i.texImage2D.apply(i,arguments)}catch(P){console.error("THREE.WebGLState:",P)}}function wt(){try{i.texImage3D.apply(i,arguments)}catch(P){console.error("THREE.WebGLState:",P)}}function Rt(P){At.equals(P)===!1&&(i.scissor(P.x,P.y,P.z,P.w),At.copy(P))}function vt(P){H.equals(P)===!1&&(i.viewport(P.x,P.y,P.z,P.w),H.copy(P))}function zt(P,mt){let q=l.get(mt);q===void 0&&(q=new WeakMap,l.set(mt,q));let j=q.get(P);j===void 0&&(j=i.getUniformBlockIndex(mt,P.name),q.set(P,j))}function Ht(P,mt){const j=l.get(mt).get(P);c.get(mt)!==j&&(i.uniformBlockBinding(mt,j,P.__bindingPointIndex),c.set(mt,j))}function Qt(){i.disable(i.BLEND),i.disable(i.CULL_FACE),i.disable(i.DEPTH_TEST),i.disable(i.POLYGON_OFFSET_FILL),i.disable(i.SCISSOR_TEST),i.disable(i.STENCIL_TEST),i.disable(i.SAMPLE_ALPHA_TO_COVERAGE),i.blendEquation(i.FUNC_ADD),i.blendFunc(i.ONE,i.ZERO),i.blendFuncSeparate(i.ONE,i.ZERO,i.ONE,i.ZERO),i.blendColor(0,0,0,0),i.colorMask(!0,!0,!0,!0),i.clearColor(0,0,0,0),i.depthMask(!0),i.depthFunc(i.LESS),a.setReversed(!1),i.clearDepth(1),i.stencilMask(4294967295),i.stencilFunc(i.ALWAYS,0,4294967295),i.stencilOp(i.KEEP,i.KEEP,i.KEEP),i.clearStencil(0),i.cullFace(i.BACK),i.frontFace(i.CCW),i.polygonOffset(0,0),i.activeTexture(i.TEXTURE0),i.bindFramebuffer(i.FRAMEBUFFER,null),i.bindFramebuffer(i.DRAW_FRAMEBUFFER,null),i.bindFramebuffer(i.READ_FRAMEBUFFER,null),i.useProgram(null),i.lineWidth(1),i.scissor(0,0,i.canvas.width,i.canvas.height),i.viewport(0,0,i.canvas.width,i.canvas.height),h={},B=null,z={},f={},d=new WeakMap,m=[],g=null,x=!1,p=null,u=null,w=null,b=null,T=null,F=null,D=null,R=new kt(0,0,0),O=0,E=!1,M=null,C=null,Z=null,W=null,J=null,At.set(0,0,i.canvas.width,i.canvas.height),H.set(0,0,i.canvas.width,i.canvas.height),s.reset(),a.reset(),o.reset()}return{buffers:{color:s,depth:a,stencil:o},enable:k,disable:rt,bindFramebuffer:st,drawBuffers:Et,useProgram:yt,setBlending:A,setMaterial:ne,setFlipSided:Ct,setCullFace:It,setLineWidth:pt,setPolygonOffset:Nt,setScissorTest:ut,activeTexture:S,bindTexture:_,unbindTexture:U,compressedTexImage2D:Y,compressedTexImage3D:$,texImage2D:dt,texImage3D:wt,updateUBOMapping:zt,uniformBlockBinding:Ht,texStorage2D:Lt,texStorage3D:nt,texSubImage2D:X,texSubImage3D:ft,compressedTexSubImage2D:lt,compressedTexSubImage3D:gt,scissor:Rt,viewport:vt,reset:Qt}}function Kp(i,t,e,n,r,s,a){const o=t.has("WEBGL_multisampled_render_to_texture")?t.get("WEBGL_multisampled_render_to_texture"):null,c=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),l=new qt,h=new WeakMap;let f;const d=new WeakMap;let m=!1;try{m=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function g(S,_){return m?new OffscreenCanvas(S,_):Nr("canvas")}function x(S,_,U){let Y=1;const $=ut(S);if(($.width>U||$.height>U)&&(Y=U/Math.max($.width,$.height)),Y<1)if(typeof HTMLImageElement<"u"&&S instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&S instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&S instanceof ImageBitmap||typeof VideoFrame<"u"&&S instanceof VideoFrame){const X=Math.floor(Y*$.width),ft=Math.floor(Y*$.height);f===void 0&&(f=g(X,ft));const lt=_?g(X,ft):f;return lt.width=X,lt.height=ft,lt.getContext("2d").drawImage(S,0,0,X,ft),console.warn("THREE.WebGLRenderer: Texture has been resized from ("+$.width+"x"+$.height+") to ("+X+"x"+ft+")."),lt}else return"data"in S&&console.warn("THREE.WebGLRenderer: Image in DataTexture is too big ("+$.width+"x"+$.height+")."),S;return S}function p(S){return S.generateMipmaps}function u(S){i.generateMipmap(S)}function w(S){return S.isWebGLCubeRenderTarget?i.TEXTURE_CUBE_MAP:S.isWebGL3DRenderTarget?i.TEXTURE_3D:S.isWebGLArrayRenderTarget||S.isCompressedArrayTexture?i.TEXTURE_2D_ARRAY:i.TEXTURE_2D}function b(S,_,U,Y,$=!1){if(S!==null){if(i[S]!==void 0)return i[S];console.warn("THREE.WebGLRenderer: Attempt to use non-existing WebGL internal format '"+S+"'")}let X=_;if(_===i.RED&&(U===i.FLOAT&&(X=i.R32F),U===i.HALF_FLOAT&&(X=i.R16F),U===i.UNSIGNED_BYTE&&(X=i.R8)),_===i.RED_INTEGER&&(U===i.UNSIGNED_BYTE&&(X=i.R8UI),U===i.UNSIGNED_SHORT&&(X=i.R16UI),U===i.UNSIGNED_INT&&(X=i.R32UI),U===i.BYTE&&(X=i.R8I),U===i.SHORT&&(X=i.R16I),U===i.INT&&(X=i.R32I)),_===i.RG&&(U===i.FLOAT&&(X=i.RG32F),U===i.HALF_FLOAT&&(X=i.RG16F),U===i.UNSIGNED_BYTE&&(X=i.RG8)),_===i.RG_INTEGER&&(U===i.UNSIGNED_BYTE&&(X=i.RG8UI),U===i.UNSIGNED_SHORT&&(X=i.RG16UI),U===i.UNSIGNED_INT&&(X=i.RG32UI),U===i.BYTE&&(X=i.RG8I),U===i.SHORT&&(X=i.RG16I),U===i.INT&&(X=i.RG32I)),_===i.RGB_INTEGER&&(U===i.UNSIGNED_BYTE&&(X=i.RGB8UI),U===i.UNSIGNED_SHORT&&(X=i.RGB16UI),U===i.UNSIGNED_INT&&(X=i.RGB32UI),U===i.BYTE&&(X=i.RGB8I),U===i.SHORT&&(X=i.RGB16I),U===i.INT&&(X=i.RGB32I)),_===i.RGBA_INTEGER&&(U===i.UNSIGNED_BYTE&&(X=i.RGBA8UI),U===i.UNSIGNED_SHORT&&(X=i.RGBA16UI),U===i.UNSIGNED_INT&&(X=i.RGBA32UI),U===i.BYTE&&(X=i.RGBA8I),U===i.SHORT&&(X=i.RGBA16I),U===i.INT&&(X=i.RGBA32I)),_===i.RGB&&U===i.UNSIGNED_INT_5_9_9_9_REV&&(X=i.RGB9_E5),_===i.RGBA){const ft=$?Ur:$t.getTransfer(Y);U===i.FLOAT&&(X=i.RGBA32F),U===i.HALF_FLOAT&&(X=i.RGBA16F),U===i.UNSIGNED_BYTE&&(X=ft===ee?i.SRGB8_ALPHA8:i.RGBA8),U===i.UNSIGNED_SHORT_4_4_4_4&&(X=i.RGBA4),U===i.UNSIGNED_SHORT_5_5_5_1&&(X=i.RGB5_A1)}return(X===i.R16F||X===i.R32F||X===i.RG16F||X===i.RG32F||X===i.RGBA16F||X===i.RGBA32F)&&t.get("EXT_color_buffer_float"),X}function T(S,_){let U;return S?_===null||_===kn||_===Mi?U=i.DEPTH24_STENCIL8:_===ln?U=i.DEPTH32F_STENCIL8:_===Hi&&(U=i.DEPTH24_STENCIL8,console.warn("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):_===null||_===kn||_===Mi?U=i.DEPTH_COMPONENT24:_===ln?U=i.DEPTH_COMPONENT32F:_===Hi&&(U=i.DEPTH_COMPONENT16),U}function F(S,_){return p(S)===!0||S.isFramebufferTexture&&S.minFilter!==Ze&&S.minFilter!==Qe?Math.log2(Math.max(_.width,_.height))+1:S.mipmaps!==void 0&&S.mipmaps.length>0?S.mipmaps.length:S.isCompressedTexture&&Array.isArray(S.image)?_.mipmaps.length:1}function D(S){const _=S.target;_.removeEventListener("dispose",D),O(_),_.isVideoTexture&&h.delete(_)}function R(S){const _=S.target;_.removeEventListener("dispose",R),M(_)}function O(S){const _=n.get(S);if(_.__webglInit===void 0)return;const U=S.source,Y=d.get(U);if(Y){const $=Y[_.__cacheKey];$.usedTimes--,$.usedTimes===0&&E(S),Object.keys(Y).length===0&&d.delete(U)}n.remove(S)}function E(S){const _=n.get(S);i.deleteTexture(_.__webglTexture);const U=S.source,Y=d.get(U);delete Y[_.__cacheKey],a.memory.textures--}function M(S){const _=n.get(S);if(S.depthTexture&&(S.depthTexture.dispose(),n.remove(S.depthTexture)),S.isWebGLCubeRenderTarget)for(let Y=0;Y<6;Y++){if(Array.isArray(_.__webglFramebuffer[Y]))for(let $=0;$<_.__webglFramebuffer[Y].length;$++)i.deleteFramebuffer(_.__webglFramebuffer[Y][$]);else i.deleteFramebuffer(_.__webglFramebuffer[Y]);_.__webglDepthbuffer&&i.deleteRenderbuffer(_.__webglDepthbuffer[Y])}else{if(Array.isArray(_.__webglFramebuffer))for(let Y=0;Y<_.__webglFramebuffer.length;Y++)i.deleteFramebuffer(_.__webglFramebuffer[Y]);else i.deleteFramebuffer(_.__webglFramebuffer);if(_.__webglDepthbuffer&&i.deleteRenderbuffer(_.__webglDepthbuffer),_.__webglMultisampledFramebuffer&&i.deleteFramebuffer(_.__webglMultisampledFramebuffer),_.__webglColorRenderbuffer)for(let Y=0;Y<_.__webglColorRenderbuffer.length;Y++)_.__webglColorRenderbuffer[Y]&&i.deleteRenderbuffer(_.__webglColorRenderbuffer[Y]);_.__webglDepthRenderbuffer&&i.deleteRenderbuffer(_.__webglDepthRenderbuffer)}const U=S.textures;for(let Y=0,$=U.length;Y<$;Y++){const X=n.get(U[Y]);X.__webglTexture&&(i.deleteTexture(X.__webglTexture),a.memory.textures--),n.remove(U[Y])}n.remove(S)}let C=0;function Z(){C=0}function W(){const S=C;return S>=r.maxTextures&&console.warn("THREE.WebGLTextures: Trying to use "+S+" texture units while this GPU supports only "+r.maxTextures),C+=1,S}function J(S){const _=[];return _.push(S.wrapS),_.push(S.wrapT),_.push(S.wrapR||0),_.push(S.magFilter),_.push(S.minFilter),_.push(S.anisotropy),_.push(S.internalFormat),_.push(S.format),_.push(S.type),_.push(S.generateMipmaps),_.push(S.premultiplyAlpha),_.push(S.flipY),_.push(S.unpackAlignment),_.push(S.colorSpace),_.join()}function tt(S,_){const U=n.get(S);if(S.isVideoTexture&&pt(S),S.isRenderTargetTexture===!1&&S.version>0&&U.__version!==S.version){const Y=S.image;if(Y===null)console.warn("THREE.WebGLRenderer: Texture marked for update but no image data found.");else if(Y.complete===!1)console.warn("THREE.WebGLRenderer: Texture marked for update but image is incomplete");else{H(U,S,_);return}}e.bindTexture(i.TEXTURE_2D,U.__webglTexture,i.TEXTURE0+_)}function K(S,_){const U=n.get(S);if(S.version>0&&U.__version!==S.version){H(U,S,_);return}e.bindTexture(i.TEXTURE_2D_ARRAY,U.__webglTexture,i.TEXTURE0+_)}function et(S,_){const U=n.get(S);if(S.version>0&&U.__version!==S.version){H(U,S,_);return}e.bindTexture(i.TEXTURE_3D,U.__webglTexture,i.TEXTURE0+_)}function y(S,_){const U=n.get(S);if(S.version>0&&U.__version!==S.version){Q(U,S,_);return}e.bindTexture(i.TEXTURE_CUBE_MAP,U.__webglTexture,i.TEXTURE0+_)}const B={[Is]:i.REPEAT,[Vn]:i.CLAMP_TO_EDGE,[Ns]:i.MIRRORED_REPEAT},z={[Ze]:i.NEAREST,[hl]:i.NEAREST_MIPMAP_NEAREST,[$i]:i.NEAREST_MIPMAP_LINEAR,[Qe]:i.LINEAR,[Xr]:i.LINEAR_MIPMAP_NEAREST,[Gn]:i.LINEAR_MIPMAP_LINEAR},it={[_l]:i.NEVER,[El]:i.ALWAYS,[gl]:i.LESS,[sc]:i.LEQUAL,[vl]:i.EQUAL,[Sl]:i.GEQUAL,[xl]:i.GREATER,[Ml]:i.NOTEQUAL};function ht(S,_){if(_.type===ln&&t.has("OES_texture_float_linear")===!1&&(_.magFilter===Qe||_.magFilter===Xr||_.magFilter===$i||_.magFilter===Gn||_.minFilter===Qe||_.minFilter===Xr||_.minFilter===$i||_.minFilter===Gn)&&console.warn("THREE.WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),i.texParameteri(S,i.TEXTURE_WRAP_S,B[_.wrapS]),i.texParameteri(S,i.TEXTURE_WRAP_T,B[_.wrapT]),(S===i.TEXTURE_3D||S===i.TEXTURE_2D_ARRAY)&&i.texParameteri(S,i.TEXTURE_WRAP_R,B[_.wrapR]),i.texParameteri(S,i.TEXTURE_MAG_FILTER,z[_.magFilter]),i.texParameteri(S,i.TEXTURE_MIN_FILTER,z[_.minFilter]),_.compareFunction&&(i.texParameteri(S,i.TEXTURE_COMPARE_MODE,i.COMPARE_REF_TO_TEXTURE),i.texParameteri(S,i.TEXTURE_COMPARE_FUNC,it[_.compareFunction])),t.has("EXT_texture_filter_anisotropic")===!0){if(_.magFilter===Ze||_.minFilter!==$i&&_.minFilter!==Gn||_.type===ln&&t.has("OES_texture_float_linear")===!1)return;if(_.anisotropy>1||n.get(_).__currentAnisotropy){const U=t.get("EXT_texture_filter_anisotropic");i.texParameterf(S,U.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(_.anisotropy,r.getMaxAnisotropy())),n.get(_).__currentAnisotropy=_.anisotropy}}}function At(S,_){let U=!1;S.__webglInit===void 0&&(S.__webglInit=!0,_.addEventListener("dispose",D));const Y=_.source;let $=d.get(Y);$===void 0&&($={},d.set(Y,$));const X=J(_);if(X!==S.__cacheKey){$[X]===void 0&&($[X]={texture:i.createTexture(),usedTimes:0},a.memory.textures++,U=!0),$[X].usedTimes++;const ft=$[S.__cacheKey];ft!==void 0&&($[S.__cacheKey].usedTimes--,ft.usedTimes===0&&E(_)),S.__cacheKey=X,S.__webglTexture=$[X].texture}return U}function H(S,_,U){let Y=i.TEXTURE_2D;(_.isDataArrayTexture||_.isCompressedArrayTexture)&&(Y=i.TEXTURE_2D_ARRAY),_.isData3DTexture&&(Y=i.TEXTURE_3D);const $=At(S,_),X=_.source;e.bindTexture(Y,S.__webglTexture,i.TEXTURE0+U);const ft=n.get(X);if(X.version!==ft.__version||$===!0){e.activeTexture(i.TEXTURE0+U);const lt=$t.getPrimaries($t.workingColorSpace),gt=_.colorSpace===Sn?null:$t.getPrimaries(_.colorSpace),Lt=_.colorSpace===Sn||lt===gt?i.NONE:i.BROWSER_DEFAULT_WEBGL;i.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,_.flipY),i.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,_.premultiplyAlpha),i.pixelStorei(i.UNPACK_ALIGNMENT,_.unpackAlignment),i.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,Lt);let nt=x(_.image,!1,r.maxTextureSize);nt=Nt(_,nt);const dt=s.convert(_.format,_.colorSpace),wt=s.convert(_.type);let Rt=b(_.internalFormat,dt,wt,_.colorSpace,_.isVideoTexture);ht(Y,_);let vt;const zt=_.mipmaps,Ht=_.isVideoTexture!==!0,Qt=ft.__version===void 0||$===!0,P=X.dataReady,mt=F(_,nt);if(_.isDepthTexture)Rt=T(_.format===Si,_.type),Qt&&(Ht?e.texStorage2D(i.TEXTURE_2D,1,Rt,nt.width,nt.height):e.texImage2D(i.TEXTURE_2D,0,Rt,nt.width,nt.height,0,dt,wt,null));else if(_.isDataTexture)if(zt.length>0){Ht&&Qt&&e.texStorage2D(i.TEXTURE_2D,mt,Rt,zt[0].width,zt[0].height);for(let q=0,j=zt.length;q<j;q++)vt=zt[q],Ht?P&&e.texSubImage2D(i.TEXTURE_2D,q,0,0,vt.width,vt.height,dt,wt,vt.data):e.texImage2D(i.TEXTURE_2D,q,Rt,vt.width,vt.height,0,dt,wt,vt.data);_.generateMipmaps=!1}else Ht?(Qt&&e.texStorage2D(i.TEXTURE_2D,mt,Rt,nt.width,nt.height),P&&e.texSubImage2D(i.TEXTURE_2D,0,0,0,nt.width,nt.height,dt,wt,nt.data)):e.texImage2D(i.TEXTURE_2D,0,Rt,nt.width,nt.height,0,dt,wt,nt.data);else if(_.isCompressedTexture)if(_.isCompressedArrayTexture){Ht&&Qt&&e.texStorage3D(i.TEXTURE_2D_ARRAY,mt,Rt,zt[0].width,zt[0].height,nt.depth);for(let q=0,j=zt.length;q<j;q++)if(vt=zt[q],_.format!==qe)if(dt!==null)if(Ht){if(P)if(_.layerUpdates.size>0){const Mt=po(vt.width,vt.height,_.format,_.type);for(const xt of _.layerUpdates){const Ot=vt.data.subarray(xt*Mt/vt.data.BYTES_PER_ELEMENT,(xt+1)*Mt/vt.data.BYTES_PER_ELEMENT);e.compressedTexSubImage3D(i.TEXTURE_2D_ARRAY,q,0,0,xt,vt.width,vt.height,1,dt,Ot)}_.clearLayerUpdates()}else e.compressedTexSubImage3D(i.TEXTURE_2D_ARRAY,q,0,0,0,vt.width,vt.height,nt.depth,dt,vt.data)}else e.compressedTexImage3D(i.TEXTURE_2D_ARRAY,q,Rt,vt.width,vt.height,nt.depth,0,vt.data,0,0);else console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else Ht?P&&e.texSubImage3D(i.TEXTURE_2D_ARRAY,q,0,0,0,vt.width,vt.height,nt.depth,dt,wt,vt.data):e.texImage3D(i.TEXTURE_2D_ARRAY,q,Rt,vt.width,vt.height,nt.depth,0,dt,wt,vt.data)}else{Ht&&Qt&&e.texStorage2D(i.TEXTURE_2D,mt,Rt,zt[0].width,zt[0].height);for(let q=0,j=zt.length;q<j;q++)vt=zt[q],_.format!==qe?dt!==null?Ht?P&&e.compressedTexSubImage2D(i.TEXTURE_2D,q,0,0,vt.width,vt.height,dt,vt.data):e.compressedTexImage2D(i.TEXTURE_2D,q,Rt,vt.width,vt.height,0,vt.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):Ht?P&&e.texSubImage2D(i.TEXTURE_2D,q,0,0,vt.width,vt.height,dt,wt,vt.data):e.texImage2D(i.TEXTURE_2D,q,Rt,vt.width,vt.height,0,dt,wt,vt.data)}else if(_.isDataArrayTexture)if(Ht){if(Qt&&e.texStorage3D(i.TEXTURE_2D_ARRAY,mt,Rt,nt.width,nt.height,nt.depth),P)if(_.layerUpdates.size>0){const q=po(nt.width,nt.height,_.format,_.type);for(const j of _.layerUpdates){const Mt=nt.data.subarray(j*q/nt.data.BYTES_PER_ELEMENT,(j+1)*q/nt.data.BYTES_PER_ELEMENT);e.texSubImage3D(i.TEXTURE_2D_ARRAY,0,0,0,j,nt.width,nt.height,1,dt,wt,Mt)}_.clearLayerUpdates()}else e.texSubImage3D(i.TEXTURE_2D_ARRAY,0,0,0,0,nt.width,nt.height,nt.depth,dt,wt,nt.data)}else e.texImage3D(i.TEXTURE_2D_ARRAY,0,Rt,nt.width,nt.height,nt.depth,0,dt,wt,nt.data);else if(_.isData3DTexture)Ht?(Qt&&e.texStorage3D(i.TEXTURE_3D,mt,Rt,nt.width,nt.height,nt.depth),P&&e.texSubImage3D(i.TEXTURE_3D,0,0,0,0,nt.width,nt.height,nt.depth,dt,wt,nt.data)):e.texImage3D(i.TEXTURE_3D,0,Rt,nt.width,nt.height,nt.depth,0,dt,wt,nt.data);else if(_.isFramebufferTexture){if(Qt)if(Ht)e.texStorage2D(i.TEXTURE_2D,mt,Rt,nt.width,nt.height);else{let q=nt.width,j=nt.height;for(let Mt=0;Mt<mt;Mt++)e.texImage2D(i.TEXTURE_2D,Mt,Rt,q,j,0,dt,wt,null),q>>=1,j>>=1}}else if(zt.length>0){if(Ht&&Qt){const q=ut(zt[0]);e.texStorage2D(i.TEXTURE_2D,mt,Rt,q.width,q.height)}for(let q=0,j=zt.length;q<j;q++)vt=zt[q],Ht?P&&e.texSubImage2D(i.TEXTURE_2D,q,0,0,dt,wt,vt):e.texImage2D(i.TEXTURE_2D,q,Rt,dt,wt,vt);_.generateMipmaps=!1}else if(Ht){if(Qt){const q=ut(nt);e.texStorage2D(i.TEXTURE_2D,mt,Rt,q.width,q.height)}P&&e.texSubImage2D(i.TEXTURE_2D,0,0,0,dt,wt,nt)}else e.texImage2D(i.TEXTURE_2D,0,Rt,dt,wt,nt);p(_)&&u(Y),ft.__version=X.version,_.onUpdate&&_.onUpdate(_)}S.__version=_.version}function Q(S,_,U){if(_.image.length!==6)return;const Y=At(S,_),$=_.source;e.bindTexture(i.TEXTURE_CUBE_MAP,S.__webglTexture,i.TEXTURE0+U);const X=n.get($);if($.version!==X.__version||Y===!0){e.activeTexture(i.TEXTURE0+U);const ft=$t.getPrimaries($t.workingColorSpace),lt=_.colorSpace===Sn?null:$t.getPrimaries(_.colorSpace),gt=_.colorSpace===Sn||ft===lt?i.NONE:i.BROWSER_DEFAULT_WEBGL;i.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,_.flipY),i.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,_.premultiplyAlpha),i.pixelStorei(i.UNPACK_ALIGNMENT,_.unpackAlignment),i.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,gt);const Lt=_.isCompressedTexture||_.image[0].isCompressedTexture,nt=_.image[0]&&_.image[0].isDataTexture,dt=[];for(let j=0;j<6;j++)!Lt&&!nt?dt[j]=x(_.image[j],!0,r.maxCubemapSize):dt[j]=nt?_.image[j].image:_.image[j],dt[j]=Nt(_,dt[j]);const wt=dt[0],Rt=s.convert(_.format,_.colorSpace),vt=s.convert(_.type),zt=b(_.internalFormat,Rt,vt,_.colorSpace),Ht=_.isVideoTexture!==!0,Qt=X.__version===void 0||Y===!0,P=$.dataReady;let mt=F(_,wt);ht(i.TEXTURE_CUBE_MAP,_);let q;if(Lt){Ht&&Qt&&e.texStorage2D(i.TEXTURE_CUBE_MAP,mt,zt,wt.width,wt.height);for(let j=0;j<6;j++){q=dt[j].mipmaps;for(let Mt=0;Mt<q.length;Mt++){const xt=q[Mt];_.format!==qe?Rt!==null?Ht?P&&e.compressedTexSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+j,Mt,0,0,xt.width,xt.height,Rt,xt.data):e.compressedTexImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+j,Mt,zt,xt.width,xt.height,0,xt.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):Ht?P&&e.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+j,Mt,0,0,xt.width,xt.height,Rt,vt,xt.data):e.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+j,Mt,zt,xt.width,xt.height,0,Rt,vt,xt.data)}}}else{if(q=_.mipmaps,Ht&&Qt){q.length>0&&mt++;const j=ut(dt[0]);e.texStorage2D(i.TEXTURE_CUBE_MAP,mt,zt,j.width,j.height)}for(let j=0;j<6;j++)if(nt){Ht?P&&e.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+j,0,0,0,dt[j].width,dt[j].height,Rt,vt,dt[j].data):e.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+j,0,zt,dt[j].width,dt[j].height,0,Rt,vt,dt[j].data);for(let Mt=0;Mt<q.length;Mt++){const Ot=q[Mt].image[j].image;Ht?P&&e.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+j,Mt+1,0,0,Ot.width,Ot.height,Rt,vt,Ot.data):e.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+j,Mt+1,zt,Ot.width,Ot.height,0,Rt,vt,Ot.data)}}else{Ht?P&&e.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+j,0,0,0,Rt,vt,dt[j]):e.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+j,0,zt,Rt,vt,dt[j]);for(let Mt=0;Mt<q.length;Mt++){const xt=q[Mt];Ht?P&&e.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+j,Mt+1,0,0,Rt,vt,xt.image[j]):e.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+j,Mt+1,zt,Rt,vt,xt.image[j])}}}p(_)&&u(i.TEXTURE_CUBE_MAP),X.__version=$.version,_.onUpdate&&_.onUpdate(_)}S.__version=_.version}function ct(S,_,U,Y,$,X){const ft=s.convert(U.format,U.colorSpace),lt=s.convert(U.type),gt=b(U.internalFormat,ft,lt,U.colorSpace),Lt=n.get(_),nt=n.get(U);if(nt.__renderTarget=_,!Lt.__hasExternalTextures){const dt=Math.max(1,_.width>>X),wt=Math.max(1,_.height>>X);$===i.TEXTURE_3D||$===i.TEXTURE_2D_ARRAY?e.texImage3D($,X,gt,dt,wt,_.depth,0,ft,lt,null):e.texImage2D($,X,gt,dt,wt,0,ft,lt,null)}e.bindFramebuffer(i.FRAMEBUFFER,S),It(_)?o.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,Y,$,nt.__webglTexture,0,Ct(_)):($===i.TEXTURE_2D||$>=i.TEXTURE_CUBE_MAP_POSITIVE_X&&$<=i.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&i.framebufferTexture2D(i.FRAMEBUFFER,Y,$,nt.__webglTexture,X),e.bindFramebuffer(i.FRAMEBUFFER,null)}function k(S,_,U){if(i.bindRenderbuffer(i.RENDERBUFFER,S),_.depthBuffer){const Y=_.depthTexture,$=Y&&Y.isDepthTexture?Y.type:null,X=T(_.stencilBuffer,$),ft=_.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,lt=Ct(_);It(_)?o.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,lt,X,_.width,_.height):U?i.renderbufferStorageMultisample(i.RENDERBUFFER,lt,X,_.width,_.height):i.renderbufferStorage(i.RENDERBUFFER,X,_.width,_.height),i.framebufferRenderbuffer(i.FRAMEBUFFER,ft,i.RENDERBUFFER,S)}else{const Y=_.textures;for(let $=0;$<Y.length;$++){const X=Y[$],ft=s.convert(X.format,X.colorSpace),lt=s.convert(X.type),gt=b(X.internalFormat,ft,lt,X.colorSpace),Lt=Ct(_);U&&It(_)===!1?i.renderbufferStorageMultisample(i.RENDERBUFFER,Lt,gt,_.width,_.height):It(_)?o.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,Lt,gt,_.width,_.height):i.renderbufferStorage(i.RENDERBUFFER,gt,_.width,_.height)}}i.bindRenderbuffer(i.RENDERBUFFER,null)}function rt(S,_){if(_&&_.isWebGLCubeRenderTarget)throw new Error("Depth Texture with cube render targets is not supported");if(e.bindFramebuffer(i.FRAMEBUFFER,S),!(_.depthTexture&&_.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");const Y=n.get(_.depthTexture);Y.__renderTarget=_,(!Y.__webglTexture||_.depthTexture.image.width!==_.width||_.depthTexture.image.height!==_.height)&&(_.depthTexture.image.width=_.width,_.depthTexture.image.height=_.height,_.depthTexture.needsUpdate=!0),tt(_.depthTexture,0);const $=Y.__webglTexture,X=Ct(_);if(_.depthTexture.format===mi)It(_)?o.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,i.DEPTH_ATTACHMENT,i.TEXTURE_2D,$,0,X):i.framebufferTexture2D(i.FRAMEBUFFER,i.DEPTH_ATTACHMENT,i.TEXTURE_2D,$,0);else if(_.depthTexture.format===Si)It(_)?o.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,i.DEPTH_STENCIL_ATTACHMENT,i.TEXTURE_2D,$,0,X):i.framebufferTexture2D(i.FRAMEBUFFER,i.DEPTH_STENCIL_ATTACHMENT,i.TEXTURE_2D,$,0);else throw new Error("Unknown depthTexture format")}function st(S){const _=n.get(S),U=S.isWebGLCubeRenderTarget===!0;if(_.__boundDepthTexture!==S.depthTexture){const Y=S.depthTexture;if(_.__depthDisposeCallback&&_.__depthDisposeCallback(),Y){const $=()=>{delete _.__boundDepthTexture,delete _.__depthDisposeCallback,Y.removeEventListener("dispose",$)};Y.addEventListener("dispose",$),_.__depthDisposeCallback=$}_.__boundDepthTexture=Y}if(S.depthTexture&&!_.__autoAllocateDepthBuffer){if(U)throw new Error("target.depthTexture not supported in Cube render targets");rt(_.__webglFramebuffer,S)}else if(U){_.__webglDepthbuffer=[];for(let Y=0;Y<6;Y++)if(e.bindFramebuffer(i.FRAMEBUFFER,_.__webglFramebuffer[Y]),_.__webglDepthbuffer[Y]===void 0)_.__webglDepthbuffer[Y]=i.createRenderbuffer(),k(_.__webglDepthbuffer[Y],S,!1);else{const $=S.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,X=_.__webglDepthbuffer[Y];i.bindRenderbuffer(i.RENDERBUFFER,X),i.framebufferRenderbuffer(i.FRAMEBUFFER,$,i.RENDERBUFFER,X)}}else if(e.bindFramebuffer(i.FRAMEBUFFER,_.__webglFramebuffer),_.__webglDepthbuffer===void 0)_.__webglDepthbuffer=i.createRenderbuffer(),k(_.__webglDepthbuffer,S,!1);else{const Y=S.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,$=_.__webglDepthbuffer;i.bindRenderbuffer(i.RENDERBUFFER,$),i.framebufferRenderbuffer(i.FRAMEBUFFER,Y,i.RENDERBUFFER,$)}e.bindFramebuffer(i.FRAMEBUFFER,null)}function Et(S,_,U){const Y=n.get(S);_!==void 0&&ct(Y.__webglFramebuffer,S,S.texture,i.COLOR_ATTACHMENT0,i.TEXTURE_2D,0),U!==void 0&&st(S)}function yt(S){const _=S.texture,U=n.get(S),Y=n.get(_);S.addEventListener("dispose",R);const $=S.textures,X=S.isWebGLCubeRenderTarget===!0,ft=$.length>1;if(ft||(Y.__webglTexture===void 0&&(Y.__webglTexture=i.createTexture()),Y.__version=_.version,a.memory.textures++),X){U.__webglFramebuffer=[];for(let lt=0;lt<6;lt++)if(_.mipmaps&&_.mipmaps.length>0){U.__webglFramebuffer[lt]=[];for(let gt=0;gt<_.mipmaps.length;gt++)U.__webglFramebuffer[lt][gt]=i.createFramebuffer()}else U.__webglFramebuffer[lt]=i.createFramebuffer()}else{if(_.mipmaps&&_.mipmaps.length>0){U.__webglFramebuffer=[];for(let lt=0;lt<_.mipmaps.length;lt++)U.__webglFramebuffer[lt]=i.createFramebuffer()}else U.__webglFramebuffer=i.createFramebuffer();if(ft)for(let lt=0,gt=$.length;lt<gt;lt++){const Lt=n.get($[lt]);Lt.__webglTexture===void 0&&(Lt.__webglTexture=i.createTexture(),a.memory.textures++)}if(S.samples>0&&It(S)===!1){U.__webglMultisampledFramebuffer=i.createFramebuffer(),U.__webglColorRenderbuffer=[],e.bindFramebuffer(i.FRAMEBUFFER,U.__webglMultisampledFramebuffer);for(let lt=0;lt<$.length;lt++){const gt=$[lt];U.__webglColorRenderbuffer[lt]=i.createRenderbuffer(),i.bindRenderbuffer(i.RENDERBUFFER,U.__webglColorRenderbuffer[lt]);const Lt=s.convert(gt.format,gt.colorSpace),nt=s.convert(gt.type),dt=b(gt.internalFormat,Lt,nt,gt.colorSpace,S.isXRRenderTarget===!0),wt=Ct(S);i.renderbufferStorageMultisample(i.RENDERBUFFER,wt,dt,S.width,S.height),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+lt,i.RENDERBUFFER,U.__webglColorRenderbuffer[lt])}i.bindRenderbuffer(i.RENDERBUFFER,null),S.depthBuffer&&(U.__webglDepthRenderbuffer=i.createRenderbuffer(),k(U.__webglDepthRenderbuffer,S,!0)),e.bindFramebuffer(i.FRAMEBUFFER,null)}}if(X){e.bindTexture(i.TEXTURE_CUBE_MAP,Y.__webglTexture),ht(i.TEXTURE_CUBE_MAP,_);for(let lt=0;lt<6;lt++)if(_.mipmaps&&_.mipmaps.length>0)for(let gt=0;gt<_.mipmaps.length;gt++)ct(U.__webglFramebuffer[lt][gt],S,_,i.COLOR_ATTACHMENT0,i.TEXTURE_CUBE_MAP_POSITIVE_X+lt,gt);else ct(U.__webglFramebuffer[lt],S,_,i.COLOR_ATTACHMENT0,i.TEXTURE_CUBE_MAP_POSITIVE_X+lt,0);p(_)&&u(i.TEXTURE_CUBE_MAP),e.unbindTexture()}else if(ft){for(let lt=0,gt=$.length;lt<gt;lt++){const Lt=$[lt],nt=n.get(Lt);e.bindTexture(i.TEXTURE_2D,nt.__webglTexture),ht(i.TEXTURE_2D,Lt),ct(U.__webglFramebuffer,S,Lt,i.COLOR_ATTACHMENT0+lt,i.TEXTURE_2D,0),p(Lt)&&u(i.TEXTURE_2D)}e.unbindTexture()}else{let lt=i.TEXTURE_2D;if((S.isWebGL3DRenderTarget||S.isWebGLArrayRenderTarget)&&(lt=S.isWebGL3DRenderTarget?i.TEXTURE_3D:i.TEXTURE_2D_ARRAY),e.bindTexture(lt,Y.__webglTexture),ht(lt,_),_.mipmaps&&_.mipmaps.length>0)for(let gt=0;gt<_.mipmaps.length;gt++)ct(U.__webglFramebuffer[gt],S,_,i.COLOR_ATTACHMENT0,lt,gt);else ct(U.__webglFramebuffer,S,_,i.COLOR_ATTACHMENT0,lt,0);p(_)&&u(lt),e.unbindTexture()}S.depthBuffer&&st(S)}function ot(S){const _=S.textures;for(let U=0,Y=_.length;U<Y;U++){const $=_[U];if(p($)){const X=w(S),ft=n.get($).__webglTexture;e.bindTexture(X,ft),u(X),e.unbindTexture()}}}const Ut=[],A=[];function ne(S){if(S.samples>0){if(It(S)===!1){const _=S.textures,U=S.width,Y=S.height;let $=i.COLOR_BUFFER_BIT;const X=S.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,ft=n.get(S),lt=_.length>1;if(lt)for(let gt=0;gt<_.length;gt++)e.bindFramebuffer(i.FRAMEBUFFER,ft.__webglMultisampledFramebuffer),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+gt,i.RENDERBUFFER,null),e.bindFramebuffer(i.FRAMEBUFFER,ft.__webglFramebuffer),i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0+gt,i.TEXTURE_2D,null,0);e.bindFramebuffer(i.READ_FRAMEBUFFER,ft.__webglMultisampledFramebuffer),e.bindFramebuffer(i.DRAW_FRAMEBUFFER,ft.__webglFramebuffer);for(let gt=0;gt<_.length;gt++){if(S.resolveDepthBuffer&&(S.depthBuffer&&($|=i.DEPTH_BUFFER_BIT),S.stencilBuffer&&S.resolveStencilBuffer&&($|=i.STENCIL_BUFFER_BIT)),lt){i.framebufferRenderbuffer(i.READ_FRAMEBUFFER,i.COLOR_ATTACHMENT0,i.RENDERBUFFER,ft.__webglColorRenderbuffer[gt]);const Lt=n.get(_[gt]).__webglTexture;i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0,i.TEXTURE_2D,Lt,0)}i.blitFramebuffer(0,0,U,Y,0,0,U,Y,$,i.NEAREST),c===!0&&(Ut.length=0,A.length=0,Ut.push(i.COLOR_ATTACHMENT0+gt),S.depthBuffer&&S.resolveDepthBuffer===!1&&(Ut.push(X),A.push(X),i.invalidateFramebuffer(i.DRAW_FRAMEBUFFER,A)),i.invalidateFramebuffer(i.READ_FRAMEBUFFER,Ut))}if(e.bindFramebuffer(i.READ_FRAMEBUFFER,null),e.bindFramebuffer(i.DRAW_FRAMEBUFFER,null),lt)for(let gt=0;gt<_.length;gt++){e.bindFramebuffer(i.FRAMEBUFFER,ft.__webglMultisampledFramebuffer),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+gt,i.RENDERBUFFER,ft.__webglColorRenderbuffer[gt]);const Lt=n.get(_[gt]).__webglTexture;e.bindFramebuffer(i.FRAMEBUFFER,ft.__webglFramebuffer),i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0+gt,i.TEXTURE_2D,Lt,0)}e.bindFramebuffer(i.DRAW_FRAMEBUFFER,ft.__webglMultisampledFramebuffer)}else if(S.depthBuffer&&S.resolveDepthBuffer===!1&&c){const _=S.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT;i.invalidateFramebuffer(i.DRAW_FRAMEBUFFER,[_])}}}function Ct(S){return Math.min(r.maxSamples,S.samples)}function It(S){const _=n.get(S);return S.samples>0&&t.has("WEBGL_multisampled_render_to_texture")===!0&&_.__useRenderToTexture!==!1}function pt(S){const _=a.render.frame;h.get(S)!==_&&(h.set(S,_),S.update())}function Nt(S,_){const U=S.colorSpace,Y=S.format,$=S.type;return S.isCompressedTexture===!0||S.isVideoTexture===!0||U!==Ei&&U!==Sn&&($t.getTransfer(U)===ee?(Y!==qe||$!==dn)&&console.warn("THREE.WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):console.error("THREE.WebGLTextures: Unsupported texture color space:",U)),_}function ut(S){return typeof HTMLImageElement<"u"&&S instanceof HTMLImageElement?(l.width=S.naturalWidth||S.width,l.height=S.naturalHeight||S.height):typeof VideoFrame<"u"&&S instanceof VideoFrame?(l.width=S.displayWidth,l.height=S.displayHeight):(l.width=S.width,l.height=S.height),l}this.allocateTextureUnit=W,this.resetTextureUnits=Z,this.setTexture2D=tt,this.setTexture2DArray=K,this.setTexture3D=et,this.setTextureCube=y,this.rebindTextures=Et,this.setupRenderTarget=yt,this.updateRenderTargetMipmap=ot,this.updateMultisampleRenderTarget=ne,this.setupDepthRenderbuffer=st,this.setupFrameBufferTexture=ct,this.useMultisampledRTT=It}function jp(i,t){function e(n,r=Sn){let s;const a=$t.getTransfer(r);if(n===dn)return i.UNSIGNED_BYTE;if(n===pa)return i.UNSIGNED_SHORT_4_4_4_4;if(n===ma)return i.UNSIGNED_SHORT_5_5_5_1;if(n===jo)return i.UNSIGNED_INT_5_9_9_9_REV;if(n===$o)return i.BYTE;if(n===Ko)return i.SHORT;if(n===Hi)return i.UNSIGNED_SHORT;if(n===da)return i.INT;if(n===kn)return i.UNSIGNED_INT;if(n===ln)return i.FLOAT;if(n===Gi)return i.HALF_FLOAT;if(n===Jo)return i.ALPHA;if(n===Qo)return i.RGB;if(n===qe)return i.RGBA;if(n===tc)return i.LUMINANCE;if(n===ec)return i.LUMINANCE_ALPHA;if(n===mi)return i.DEPTH_COMPONENT;if(n===Si)return i.DEPTH_STENCIL;if(n===nc)return i.RED;if(n===_a)return i.RED_INTEGER;if(n===ic)return i.RG;if(n===ga)return i.RG_INTEGER;if(n===va)return i.RGBA_INTEGER;if(n===br||n===wr||n===Rr||n===Cr)if(a===ee)if(s=t.get("WEBGL_compressed_texture_s3tc_srgb"),s!==null){if(n===br)return s.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(n===wr)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(n===Rr)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(n===Cr)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(s=t.get("WEBGL_compressed_texture_s3tc"),s!==null){if(n===br)return s.COMPRESSED_RGB_S3TC_DXT1_EXT;if(n===wr)return s.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(n===Rr)return s.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(n===Cr)return s.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(n===Fs||n===Os||n===Bs||n===zs)if(s=t.get("WEBGL_compressed_texture_pvrtc"),s!==null){if(n===Fs)return s.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(n===Os)return s.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(n===Bs)return s.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(n===zs)return s.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(n===Hs||n===Vs||n===Gs)if(s=t.get("WEBGL_compressed_texture_etc"),s!==null){if(n===Hs||n===Vs)return a===ee?s.COMPRESSED_SRGB8_ETC2:s.COMPRESSED_RGB8_ETC2;if(n===Gs)return a===ee?s.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:s.COMPRESSED_RGBA8_ETC2_EAC}else return null;if(n===ks||n===Ws||n===Xs||n===qs||n===Ys||n===Zs||n===$s||n===Ks||n===js||n===Js||n===Qs||n===ta||n===ea||n===na)if(s=t.get("WEBGL_compressed_texture_astc"),s!==null){if(n===ks)return a===ee?s.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:s.COMPRESSED_RGBA_ASTC_4x4_KHR;if(n===Ws)return a===ee?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:s.COMPRESSED_RGBA_ASTC_5x4_KHR;if(n===Xs)return a===ee?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:s.COMPRESSED_RGBA_ASTC_5x5_KHR;if(n===qs)return a===ee?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:s.COMPRESSED_RGBA_ASTC_6x5_KHR;if(n===Ys)return a===ee?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:s.COMPRESSED_RGBA_ASTC_6x6_KHR;if(n===Zs)return a===ee?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:s.COMPRESSED_RGBA_ASTC_8x5_KHR;if(n===$s)return a===ee?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:s.COMPRESSED_RGBA_ASTC_8x6_KHR;if(n===Ks)return a===ee?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:s.COMPRESSED_RGBA_ASTC_8x8_KHR;if(n===js)return a===ee?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:s.COMPRESSED_RGBA_ASTC_10x5_KHR;if(n===Js)return a===ee?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:s.COMPRESSED_RGBA_ASTC_10x6_KHR;if(n===Qs)return a===ee?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:s.COMPRESSED_RGBA_ASTC_10x8_KHR;if(n===ta)return a===ee?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:s.COMPRESSED_RGBA_ASTC_10x10_KHR;if(n===ea)return a===ee?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:s.COMPRESSED_RGBA_ASTC_12x10_KHR;if(n===na)return a===ee?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:s.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(n===Pr||n===ia||n===ra)if(s=t.get("EXT_texture_compression_bptc"),s!==null){if(n===Pr)return a===ee?s.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:s.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(n===ia)return s.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(n===ra)return s.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(n===rc||n===sa||n===aa||n===oa)if(s=t.get("EXT_texture_compression_rgtc"),s!==null){if(n===Pr)return s.COMPRESSED_RED_RGTC1_EXT;if(n===sa)return s.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(n===aa)return s.COMPRESSED_RED_GREEN_RGTC2_EXT;if(n===oa)return s.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return n===Mi?i.UNSIGNED_INT_24_8:i[n]!==void 0?i[n]:null}return{convert:e}}const Jp={type:"move"};class Ms{constructor(){this._targetRay=null,this._grip=null,this._hand=null}getHandSpace(){return this._hand===null&&(this._hand=new De,this._hand.matrixAutoUpdate=!1,this._hand.visible=!1,this._hand.joints={},this._hand.inputState={pinching:!1}),this._hand}getTargetRaySpace(){return this._targetRay===null&&(this._targetRay=new De,this._targetRay.matrixAutoUpdate=!1,this._targetRay.visible=!1,this._targetRay.hasLinearVelocity=!1,this._targetRay.linearVelocity=new N,this._targetRay.hasAngularVelocity=!1,this._targetRay.angularVelocity=new N),this._targetRay}getGripSpace(){return this._grip===null&&(this._grip=new De,this._grip.matrixAutoUpdate=!1,this._grip.visible=!1,this._grip.hasLinearVelocity=!1,this._grip.linearVelocity=new N,this._grip.hasAngularVelocity=!1,this._grip.angularVelocity=new N),this._grip}dispatchEvent(t){return this._targetRay!==null&&this._targetRay.dispatchEvent(t),this._grip!==null&&this._grip.dispatchEvent(t),this._hand!==null&&this._hand.dispatchEvent(t),this}connect(t){if(t&&t.hand){const e=this._hand;if(e)for(const n of t.hand.values())this._getHandJoint(e,n)}return this.dispatchEvent({type:"connected",data:t}),this}disconnect(t){return this.dispatchEvent({type:"disconnected",data:t}),this._targetRay!==null&&(this._targetRay.visible=!1),this._grip!==null&&(this._grip.visible=!1),this._hand!==null&&(this._hand.visible=!1),this}update(t,e,n){let r=null,s=null,a=null;const o=this._targetRay,c=this._grip,l=this._hand;if(t&&e.session.visibilityState!=="visible-blurred"){if(l&&t.hand){a=!0;for(const x of t.hand.values()){const p=e.getJointPose(x,n),u=this._getHandJoint(l,x);p!==null&&(u.matrix.fromArray(p.transform.matrix),u.matrix.decompose(u.position,u.rotation,u.scale),u.matrixWorldNeedsUpdate=!0,u.jointRadius=p.radius),u.visible=p!==null}const h=l.joints["index-finger-tip"],f=l.joints["thumb-tip"],d=h.position.distanceTo(f.position),m=.02,g=.005;l.inputState.pinching&&d>m+g?(l.inputState.pinching=!1,this.dispatchEvent({type:"pinchend",handedness:t.handedness,target:this})):!l.inputState.pinching&&d<=m-g&&(l.inputState.pinching=!0,this.dispatchEvent({type:"pinchstart",handedness:t.handedness,target:this}))}else c!==null&&t.gripSpace&&(s=e.getPose(t.gripSpace,n),s!==null&&(c.matrix.fromArray(s.transform.matrix),c.matrix.decompose(c.position,c.rotation,c.scale),c.matrixWorldNeedsUpdate=!0,s.linearVelocity?(c.hasLinearVelocity=!0,c.linearVelocity.copy(s.linearVelocity)):c.hasLinearVelocity=!1,s.angularVelocity?(c.hasAngularVelocity=!0,c.angularVelocity.copy(s.angularVelocity)):c.hasAngularVelocity=!1));o!==null&&(r=e.getPose(t.targetRaySpace,n),r===null&&s!==null&&(r=s),r!==null&&(o.matrix.fromArray(r.transform.matrix),o.matrix.decompose(o.position,o.rotation,o.scale),o.matrixWorldNeedsUpdate=!0,r.linearVelocity?(o.hasLinearVelocity=!0,o.linearVelocity.copy(r.linearVelocity)):o.hasLinearVelocity=!1,r.angularVelocity?(o.hasAngularVelocity=!0,o.angularVelocity.copy(r.angularVelocity)):o.hasAngularVelocity=!1,this.dispatchEvent(Jp)))}return o!==null&&(o.visible=r!==null),c!==null&&(c.visible=s!==null),l!==null&&(l.visible=a!==null),this}_getHandJoint(t,e){if(t.joints[e.jointName]===void 0){const n=new De;n.matrixAutoUpdate=!1,n.visible=!1,t.joints[e.jointName]=n,t.add(n)}return t.joints[e.jointName]}}const Qp=`
void main() {
...
}`;class em{constructor(){this.texture=null,this.mesh=null,this.depthNear=0,this.depthFar=0}init(t,e,n){if(this.texture===null){const r=new Te,s=t.properties.get(r);s.__webglTexture=e.texture,(e.depthNear!==n.depthNear||e.depthFar!==n.depthFar)&&(this.depthNear=e.depthNear,this.depthFar=e.depthFar),this.texture=r}}getMesh(t){if(this.texture!==null&&this.mesh===null){const e=t.cameras[0].viewport,n=new An({vertexShader:Qp,fragmentShader:tm,uniforms:{depthColor:{value:this.texture},depthWidth:{value:e.z},depthHeight:{value:e.w}}});this.mesh=new Ye(new Vr(20,20),n)}return this.mesh}reset(){this.texture=null,this.mesh=null}getDepthTexture(){return this.texture}}class nm extends Ti{constructor(t,e){super();const n=this;let r=null,s=1,a=null,o="local-floor",c=1,l=null,h=null,f=null,d=null,m=null,g=null;const x=new em,p=e.getContextAttributes();let u=null,w=null;const b=[],T=[],F=new qt;let D=null;const R=new Fe;R.viewport=new le;const O=new Fe;O.viewport=new le;const E=[R,O],M=new Su;let C=null,Z=null;this.cameraAutoUpdate=!0,this.enabled=!1,this.isPresenting=!1,this.getController=function(H){let Q=b[H];return Q===void 0&&(Q=new Ms,b[H]=Q),Q.getTargetRaySpace()},this.getControllerGrip=function(H){let Q=b[H];return Q===void 0&&(Q=new Ms,b[H]=Q),Q.getGripSpace()},this.getHand=function(H){let Q=b[H];return Q===void 0&&(Q=new Ms,b[H]=Q),Q.getHandSpace()};function W(H){const Q=T.indexOf(H.inputSource);if(Q===-1)return;const ct=b[Q];ct!==void 0&&(ct.update(H.inputSource,H.frame,l||a),ct.dispatchEvent({type:H.type,data:H.inputSource}))}function J(){r.removeEventListener("select",W),r.removeEventListener("selectstart",W),r.removeEventListener("selectend",W),r.removeEventListener("squeeze",W),r.removeEventListener("squeezestart",W),r.removeEventListener("squeezeend",W),r.removeEventListener("end",J),r.removeEventListener("inputsourceschange",tt);for(let H=0;H<b.length;H++){const Q=T[H];Q!==null&&(T[H]=null,b[H].disconnect(Q))}C=null,Z=null,x.reset(),t.setRenderTarget(u),m=null,d=null,f=null,r=null,w=null,At.stop(),n.isPresenting=!1,t.setPixelRatio(D),t.setSize(F.width,F.height,!1),n.dispatchEvent({type:"sessionend"})}this.setFramebufferScaleFactor=function(H){s=H,n.isPresenting===!0&&console.warn("THREE.WebXRManager: Cannot change framebuffer scale while presenting.")},this.setReferenceSpaceType=function(H){o=H,n.isPresenting===!0&&console.warn("THREE.WebXRManager: Cannot change reference space type while presenting.")},this.getReferenceSpace=function(){return l||a},this.setReferenceSpace=function(H){l=H},this.getBaseLayer=function(){return d!==null?d:m},this.getBinding=function(){return f},this.getFrame=function(){return g},this.getSession=function(){return r},this.setSession=async function(H){if(r=H,r!==null){if(u=t.getRenderTarget(),r.addEventListener("select",W),r.addEventListener("selectstart",W),r.addEventListener("selectend",W),r.addEventListener("squeeze",W),r.addEventListener("squeezestart",W),r.addEventListener("squeezeend",W),r.addEventListener("end",J),r.addEventListener("inputsourceschange",tt),p.xrCompatible!==!0&&await e.makeXRCompatible(),D=t.getPixelRatio(),t.getSize(F),r.enabledFeatures!==void 0&&r.enabledFeatures.includes("layers")){let ct=null,k=null,rt=null;p.depth&&(rt=p.stencil?e.DEPTH24_STENCIL8:e.DEPTH_COMPONENT24,ct=p.stencil?Si:mi,k=p.stencil?Mi:kn);const st={colorFormat:e.RGBA8,depthFormat:rt,scaleFactor:s};f=new XRWebGLBinding(r,e),d=f.createProjectionLayer(st),r.updateRenderState({layers:[d]}),t.setPixelRatio(1),t.setSize(d.textureWidth,d.textureHeight,!1),w=new Wn(d.textureWidth,d.textureHeight,{format:qe,type:dn,depthTexture:new vc(d.textureWidth,d.textureHeight,k,void 0,void 0,void 0,void 0,void 0,void 0,ct),stencilBuffer:p.stencil,colorSpace:t.outputColorSpace,samples:p.antialias?4:0,resolveDepthBuffer:d.ignoreDepthValues===!1})}else{const ct={antialias:p.antialias,alpha:!0,depth:p.depth,stencil:p.stencil,framebufferScaleFactor:s};m=new XRWebGLLayer(r,e,ct),r.updateRenderState({baseLayer:m}),t.setPixelRatio(1),t.setSize(m.framebufferWidth,m.framebufferHeight,!1),w=new Wn(m.framebufferWidth,m.framebufferHeight,{format:qe,type:dn,colorSpace:t.outputColorSpace,stencilBuffer:p.stencil})}w.isXRRenderTarget=!0,this.setFoveation(c),l=null,a=await r.requestReferenceSpace(o),At.setContext(r),At.start(),n.isPresenting=!0,n.dispatchEvent({type:"sessionstart"})}},this.getEnvironmentBlendMode=function(){if(r!==null)return r.environmentBlendMode},this.getDepthTexture=function(){return x.getDepthTexture()};function tt(H){for(let Q=0;Q<H.removed.length;Q++){const ct=H.removed[Q],k=T.indexOf(ct);k>=0&&(T[k]=null,b[k].disconnect(ct))}for(let Q=0;Q<H.added.length;Q++){const ct=H.added[Q];let k=T.indexOf(ct);if(k===-1){for(let st=0;st<b.length;st++)if(st>=T.length){T.push(ct),k=st;break}else if(T[st]===null){T[st]=ct,k=st;break}if(k===-1)break}const rt=b[k];rt&&rt.connect(ct)}}const K=new N,et=new N;function y(H,Q,ct){K.setFromMatrixPosition(Q.matrixWorld),et.setFromMatrixPosition(ct.matrixWorld);const k=K.distanceTo(et),rt=Q.projectionMatrix.elements,st=ct.projectionMatrix.elements,Et=rt[14]/(rt[10]-1),yt=rt[14]/(rt[10]+1),ot=(rt[9]+1)/rt[5],Ut=(rt[9]-1)/rt[5],A=(rt[8]-1)/rt[0],ne=(st[8]+1)/st[0],Ct=Et*A,It=Et*ne,pt=k/(-A+ne),Nt=pt*-A;if(Q.matrixWorld.decompose(H.position,H.quaternion,H.scale),H.translateX(Nt),H.translateZ(pt),H.matrixWorld.compose(H.position,H.quaternion,H.scale),H.matrixWorldInverse.copy(H.matrixWorld).invert(),rt[10]===-1)H.projectionMatrix.copy(Q.projectionMatrix),H.projectionMatrixInverse.copy(Q.projectionMatrixInverse);else{const ut=Et+pt,S=yt+pt,_=Ct-Nt,U=It+(k-Nt),Y=ot*yt/S*ut,$=Ut*yt/S*ut;H.projectionMatrix.makePerspective(_,U,Y,$,ut,S),H.projectionMatrixInverse.copy(H.projectionMatrix).invert()}}function B(H,Q){Q===null?H.matrixWorld.copy(H.matrix):H.matrixWorld.multiplyMatrices(Q.matrixWorld,H.matrix),H.matrixWorldInverse.copy(H.matrixWorld).invert()}this.updateCamera=function(H){if(r===null)return;let Q=H.near,ct=H.far;x.texture!==null&&(x.depthNear>0&&(Q=x.depthNear),x.depthFar>0&&(ct=x.depthFar)),M.near=O.near=R.near=Q,M.far=O.far=R.far=ct,(C!==M.near||Z!==M.far)&&(r.updateRenderState({depthNear:M.near,depthFar:M.far}),C=M.near,Z=M.far),R.layers.mask=H.layers.mask|2,O.layers.mask=H.layers.mask|4,M.layers.mask=R.layers.mask|O.layers.mask;const k=H.parent,rt=M.cameras;B(M,k);for(let st=0;st<rt.length;st++)B(rt[st],k);rt.length===2?y(M,R,O):M.projectionMatrix.copy(R.projectionMatrix),z(H,M,k)};function z(H,Q,ct){ct===null?H.matrix.copy(Q.matrixWorld):(H.matrix.copy(ct.matrixWorld),H.matrix.invert(),H.matrix.multiply(Q.matrixWorld)),H.matrix.decompose(H.position,H.quaternion,H.scale),H.updateMatrixWorld(!0),H.projectionMatrix.copy(Q.projectionMatrix),H.projectionMatrixInverse.copy(Q.projectionMatrixInverse),H.isPerspectiveCamera&&(H.fov=Vi*2*Math.atan(1/H.projectionMatrix.elements[5]),H.zoom=1)}this.getCamera=function(){return M},this.getFoveation=function(){if(!(d===null&&m===null))return c},this.setFoveation=function(H){c=H,d!==null&&(d.fixedFoveation=H),m!==null&&m.fixedFoveation!==void 0&&(m.fixedFoveation=H)},this.hasDepthSensing=function(){return x.texture!==null},this.getDepthSensingMesh=function(){return x.getMesh(M)};let it=null;function ht(H,Q){if(h=Q.getViewerPose(l||a),g=Q,h!==null){const ct=h.views;m!==null&&(t.setRenderTargetFramebuffer(w,m.framebuffer),t.setRenderTarget(w));let k=!1;ct.length!==M.cameras.length&&(M.cameras.length=0,k=!0);for(let st=0;st<ct.length;st++){const Et=ct[st];let yt=null;if(m!==null)yt=m.getViewport(Et);else{const Ut=f.getViewSubImage(d,Et);yt=Ut.viewport,st===0&&(t.setRenderTargetTextures(w,Ut.colorTexture,d.ignoreDepthValues?void 0:Ut.depthStencilTexture),t.setRenderTarget(w))}let ot=E[st];ot===void 0&&(ot=new Fe,ot.layers.enable(st),ot.viewport=new le,E[st]=ot),ot.matrix.fromArray(Et.transform.matrix),ot.matrix.decompose(ot.position,ot.quaternion,ot.scale),ot.projectionMatrix.fromArray(Et.projectionMatrix),ot.projectionMatrixInverse.copy(ot.projectionMatrix).invert(),ot.viewport.set(yt.x,yt.y,yt.width,yt.height),st===0&&(M.matrix.copy(ot.matrix),M.matrix.decompose(M.position,M.quaternion,M.scale)),k===!0&&M.cameras.push(ot)}const rt=r.enabledFeatures;if(rt&&rt.includes("depth-sensing")){const st=f.getDepthInformation(ct[0]);st&&st.isValid&&st.texture&&x.init(t,st,r.renderState)}}for(let ct=0;ct<b.length;ct++){const k=T[ct],rt=b[ct];k!==null&&rt!==void 0&&rt.update(k,Q,l||a)}it&&it(H,Q),Q.detectedPlanes&&n.dispatchEvent({type:"planesdetected",data:Q}),g=null}const At=new xc;At.setAnimationLoop(ht),this.setAnimationLoop=function(H){it=H},this.dispose=function(){}}}const Un=new pn,im=new oe;function rm(i,t){function e(p,u){p.matrixAutoUpdate===!0&&p.updateMatrix(),u.value.copy(p.matrix)}function n(p,u){u.color.getRGB(p.fogColor.value,dc(i)),u.isFog?(p.fogNear.value=u.near,p.fogFar.value=u.far):u.isFogExp2&&(p.fogDensity.value=u.density)}function r(p,u,w,b,T){u.isMeshBasicMaterial||u.isMeshLambertMaterial?s(p,u):u.isMeshToonMaterial?(s(p,u),f(p,u)):u.isMeshPhongMaterial?(s(p,u),h(p,u)):u.isMeshStandardMaterial?(s(p,u),d(p,u),u.isMeshPhysicalMaterial&&m(p,u,T)):u.isMeshMatcapMaterial?(s(p,u),g(p,u)):u.isMeshDepthMaterial?s(p,u):u.isMeshDistanceMaterial?(s(p,u),x(p,u)):u.isMeshNormalMaterial?s(p,u):u.isLineBasicMaterial?(a(p,u),u.isLineDashedMaterial&&o(p,u)):u.isPointsMaterial?c(p,u,w,b):u.isSpriteMaterial?l(p,u):u.isShadowMaterial?(p.color.value.copy(u.color),p.opacity.value=u.opacity):u.isShaderMaterial&&(u.uniformsNeedUpdate=!1)}function s(p,u){p.opacity.value=u.opacity,u.color&&p.diffuse.value.copy(u.color),u.emissive&&p.emissive.value.copy(u.emissive).multiplyScalar(u.emissiveIntensity),u.map&&(p.map.value=u.map,e(u.map,p.mapTransform)),u.alphaMap&&(p.alphaMap.value=u.alphaMap,e(u.alphaMap,p.alphaMapTransform)),u.bumpMap&&(p.bumpMap.value=u.bumpMap,e(u.bumpMap,p.bumpMapTransform),p.bumpScale.value=u.bumpScale,u.side===we&&(p.bumpScale.value*=-1)),u.normalMap&&(p.normalMap.value=u.normalMap,e(u.normalMap,p.normalMapTransform),p.normalScale.value.copy(u.normalScale),u.side===we&&p.normalScale.value.negate()),u.displacementMap&&(p.displacementMap.value=u.displacementMap,e(u.displacementMap,p.displacementMapTransform),p.displacementScale.value=u.displacementScale,p.displacementBias.value=u.displacementBias),u.emissiveMap&&(p.emissiveMap.value=u.emissiveMap,e(u.emissiveMap,p.emissiveMapTransform)),u.specularMap&&(p.specularMap.value=u.specularMap,e(u.specularMap,p.specularMapTransform)),u.alphaTest>0&&(p.alphaTest.value=u.alphaTest);const w=t.get(u),b=w.envMap,T=w.envMapRotation;b&&(p.envMap.value=b,Un.copy(T),Un.x*=-1,Un.y*=-1,Un.z*=-1,b.isCubeTexture&&b.isRenderTargetTexture===!1&&(Un.y*=-1,Un.z*=-1),p.envMapRotation.value.setFromMatrix4(im.makeRotationFromEuler(Un)),p.flipEnvMap.value=b.isCubeTexture&&b.isRenderTargetTexture===!1?-1:1,p.reflectivity.value=u.reflectivity,p.ior.value=u.ior,p.refractionRatio.value=u.refractionRatio),u.lightMap&&(p.lightMap.value=u.lightMap,p.lightMapIntensity.value=u.lightMapIntensity,e(u.lightMap,p.lightMapTransform)),u.aoMap&&(p.aoMap.value=u.aoMap,p.aoMapIntensity.value=u.aoMapIntensity,e(u.aoMap,p.aoMapTransform))}function a(p,u){p.diffuse.value.copy(u.color),p.opacity.value=u.opacity,u.map&&(p.map.value=u.map,e(u.map,p.mapTransform))}function o(p,u){p.dashSize.value=u.dashSize,p.totalSize.value=u.dashSize+u.gapSize,p.scale.value=u.scale}function c(p,u,w,b){p.diffuse.value.copy(u.color),p.opacity.value=u.opacity,p.size.value=u.size*w,p.scale.value=b*.5,u.map&&(p.map.value=u.map,e(u.map,p.uvTransform)),u.alphaMap&&(p.alphaMap.value=u.alphaMap,e(u.alphaMap,p.alphaMapTransform)),u.alphaTest>0&&(p.alphaTest.value=u.alphaTest)}function l(p,u){p.diffuse.value.copy(u.color),p.opacity.value=u.opacity,p.rotation.value=u.rotation,u.map&&(p.map.value=u.map,e(u.map,p.mapTransform)),u.alphaMap&&(p.alphaMap.value=u.alphaMap,e(u.alphaMap,p.alphaMapTransform)),u.alphaTest>0&&(p.alphaTest.value=u.alphaTest)}function h(p,u){p.specular.value.copy(u.specular),p.shininess.value=Math.max(u.shininess,1e-4)}function f(p,u){u.gradientMap&&(p.gradientMap.value=u.gradientMap)}function d(p,u){p.metalness.value=u.metalness,u.metalnessMap&&(p.metalnessMap.value=u.metalnessMap,e(u.metalnessMap,p.metalnessMapTransform)),p.roughness.value=u.roughness,u.roughnessMap&&(p.roughnessMap.value=u.roughnessMap,e(u.roughnessMap,p.roughnessMapTransform)),u.envMap&&(p.envMapIntensity.value=u.envMapIntensity)}function m(p,u,w){p.ior.value=u.ior,u.sheen>0&&(p.sheenColor.value.copy(u.sheenColor).multiplyScalar(u.sheen),p.sheenRoughness.value=u.sheenRoughness,u.sheenColorMap&&(p.sheenColorMap.value=u.sheenColorMap,e(u.sheenColorMap,p.sheenColorMapTransform)),u.sheenRoughnessMap&&(p.sheenRoughnessMap.value=u.sheenRoughnessMap,e(u.sheenRoughnessMap,p.sheenRoughnessMapTransform))),u.clearcoat>0&&(p.clearcoat.value=u.clearcoat,p.clearcoatRoughness.value=u.clearcoatRoughness,u.clearcoatMap&&(p.clearcoatMap.value=u.clearcoatMap,e(u.clearcoatMap,p.clearcoatMapTransform)),u.clearcoatRoughnessMap&&(p.clearcoatRoughnessMap.value=u.clearcoatRoughnessMap,e(u.clearcoatRoughnessMap,p.clearcoatRoughnessMapTransform)),u.clearcoatNormalMap&&(p.clearcoatNormalMap.value=u.clearcoatNormalMap,e(u.clearcoatNormalMap,p.clearcoatNormalMapTransform),p.clearcoatNormalScale.value.copy(u.clearcoatNormalScale),u.side===we&&p.clearcoatNormalScale.value.negate())),u.dispersion>0&&(p.dispersion.value=u.dispersion),u.iridescence>0&&(p.iridescence.value=u.iridescence,p.iridescenceIOR.value=u.iridescenceIOR,p.iridescenceThicknessMinimum.value=u.iridescenceThicknessRange[0],p.iridescenceThicknessMaximum.value=u.iridescenceThicknessRange[1],u.iridescenceMap&&(p.iridescenceMap.value=u.iridescenceMap,e(u.iridescenceMap,p.iridescenceMapTransform)),u.iridescenceThicknessMap&&(p.iridescenceThicknessMap.value=u.iridescenceThicknessMap,e(u.iridescenceThicknessMap,p.iridescenceThicknessMapTransform))),u.transmission>0&&(p.transmission.value=u.transmission,p.transmissionSamplerMap.value=w.texture,p.transmissionSamplerSize.value.set(w.width,w.height),u.transmissionMap&&(p.transmissionMap.value=u.transmissionMap,e(u.transmissionMap,p.transmissionMapTransform)),p.thickness.value=u.thickness,u.thicknessMap&&(p.thicknessMap.value=u.thicknessMap,e(u.thicknessMap,p.thicknessMapTransform)),p.attenuationDistance.value=u.attenuationDistance,p.attenuationColor.value.copy(u.attenuationColor)),u.anisotropy>0&&(p.anisotropyVector.value.set(u.anisotropy*Math.cos(u.anisotropyRotation),u.anisotropy*Math.sin(u.anisotropyRotation)),u.anisotropyMap&&(p.anisotropyMap.value=u.anisotropyMap,e(u.anisotropyMap,p.anisotropyMapTransform))),p.specularIntensity.value=u.specularIntensity,p.specularColor.value.copy(u.specularColor),u.specularColorMap&&(p.specularColorMap.value=u.specularColorMap,e(u.specularColorMap,p.specularColorMapTransform)),u.specularIntensityMap&&(p.specularIntensityMap.value=u.specularIntensityMap,e(u.specularIntensityMap,p.specularIntensityMapTransform))}function g(p,u){u.matcap&&(p.matcap.value=u.matcap)}function x(p,u){const w=t.get(u).light;p.referencePosition.value.setFromMatrixPosition(w.matrixWorld),p.nearDistance.value=w.shadow.camera.near,p.farDistance.value=w.shadow.camera.far}return{refreshFogUniforms:n,refreshMaterialUniforms:r}}function sm(i,t,e,n){let r={},s={},a=[];const o=i.getParameter(i.MAX_UNIFORM_BUFFER_BINDINGS);function c(w,b){const T=b.program;n.uniformBlockBinding(w,T)}function l(w,b){let T=r[w.id];T===void 0&&(g(w),T=h(w),r[w.id]=T,w.addEventListener("dispose",p));const F=b.program;n.updateUBOMapping(w,F);const D=t.render.frame;s[w.id]!==D&&(d(w),s[w.id]=D)}function h(w){const b=f();w.__bindingPointIndex=b;const T=i.createBuffer(),F=w.__size,D=w.usage;return i.bindBuffer(i.UNIFORM_BUFFER,T),i.bufferData(i.UNIFORM_BUFFER,F,D),i.bindBuffer(i.UNIFORM_BUFFER,null),i.bindBufferBase(i.UNIFORM_BUFFER,b,T),T}function f(){for(let w=0;w<o;w++)if(a.indexOf(w)===-1)return a.push(w),w;return console.error("THREE.WebGLRenderer: Maximum number of simultaneously usable uniforms groups reached."),0}function d(w){const b=r[w.id],T=w.uniforms,F=w.__cache;i.bindBuffer(i.UNIFORM_BUFFER,b);for(let D=0,R=T.length;D<R;D++){const O=Array.isArray(T[D])?T[D]:[T[D]];for(let E=0,M=O.length;E<M;E++){const C=O[E];if(m(C,D,E,F)===!0){const Z=C.__offset,W=Array.isArray(C.value)?C.value:[C.value];let J=0;for(let tt=0;tt<W.length;tt++){const K=W[tt],et=x(K);typeof K=="number"||typeof K=="boolean"?(C.__data[0]=K,i.bufferSubData(i.UNIFORM_BUFFER,Z+J,C.__data)):K.isMatrix3?(C.__data[0]=K.elements[0],C.__data[1]=K.elements[1],C.__data[2]=K.elements[2],C.__data[3]=0,C.__data[4]=K.elements[3],C.__data[5]=K.elements[4],C.__data[6]=K.elements[5],C.__data[7]=0,C.__data[8]=K.elements[6],C.__data[9]=K.elements[7],C.__data[10]=K.elements[8],C.__data[11]=0):(K.toArray(C.__data,J),J+=et.storage/Float32Array.BYTES_PER_ELEMENT)}i.bufferSubData(i.UNIFORM_BUFFER,Z,C.__data)}}}i.bindBuffer(i.UNIFORM_BUFFER,null)}function m(w,b,T,F){const D=w.value,R=b+"_"+T;if(F[R]===void 0)return typeof D=="number"||typeof D=="boolean"?F[R]=D:F[R]=D.clone(),!0;{const O=F[R];if(typeof D=="number"||typeof D=="boolean"){if(O!==D)return F[R]=D,!0}else if(O.equals(D)===!1)return O.copy(D),!0}return!1}function g(w){const b=w.uniforms;let T=0;const F=16;for(let R=0,O=b.length;R<O;R++){const E=Array.isArray(b[R])?b[R]:[b[R]];for(let M=0,C=E.length;M<C;M++){const Z=E[M],W=Array.isArray(Z.value)?Z.value:[Z.value];for(let J=0,tt=W.length;J<tt;J++){const K=W[J],et=x(K),y=T%F,B=y%et.boundary,z=y+B;T+=B,z!==0&&F-z<et.storage&&(T+=F-z),Z.__data=new Float32Array(et.storage/Float32Array.BYTES_PER_ELEMENT),Z.__offset=T,T+=et.storage}}}const D=T%F;return D>0&&(T+=F-D),w.__size=T,w.__cache={},this}function x(w){const b={boundary:0,storage:0};return typeof w=="number"||typeof w=="boolean"?(b.boundary=4,b.storage=4):w.isVector2?(b.boundary=8,b.storage=8):w.isVector3||w.isColor?(b.boundary=16,b.storage=12):w.isVector4?(b.boundary=16,b.storage=16):w.isMatrix3?(b.boundary=48,b.storage=48):w.isMatrix4?(b.boundary=64,b.storage=64):w.isTexture?console.warn("THREE.WebGLRenderer: Texture samplers can not be part of an uniforms group."):console.warn("THREE.WebGLRenderer: Unsupported uniform value type.",w),b}function p(w){const b=w.target;b.removeEventListener("dispose",p);const T=a.indexOf(b.__bindingPointIndex);a.splice(T,1),i.deleteBuffer(r[b.id]),delete r[b.id],delete s[b.id]}function u(){for(const w in r)i.deleteBuffer(r[w]);a=[],r={},s={}}return{bind:c,update:l,dispose:u}}class am{constructor(t={}){const{canvas:e=zl(),context:n=null,depth:r=!0,stencil:s=!1,alpha:a=!1,antialias:o=!1,premultipliedAlpha:c=!0,preserveDrawingBuffer:l=!1,powerPreference:h="default",failIfMajorPerformanceCaveat:f=!1,reverseDepthBuffer:d=!1}=t;this.isWebGLRenderer=!0;let m;if(n!==null){if(typeof WebGLRenderingContext<"u"&&n instanceof WebGLRenderingContext)throw new Error("THREE.WebGLRenderer: WebGL 1 is not supported since r163.");m=n.getContextAttributes().alpha}else m=a;const g=new Uint32Array(4),x=new Int32Array(4);let p=null,u=null;const w=[],b=[];this.domElement=e,this.debug={checkShaderErrors:!0,onShaderError:null},this.autoClear=!0,this.autoClearColor=!0,this.autoClearDepth=!0,this.autoClearStencil=!0,this.sortObjects=!0,this.clippingPlanes=[],this.localClippingEnabled=!1,this._outputColorSpace=be,this.toneMapping=yn,this.toneMappingExposure=1;const T=this;let F=!1,D=0,R=0,O=null,E=-1,M=null;const C=new le,Z=new le;let W=null;const J=new kt(0);let tt=0,K=e.width,et=e.height,y=1,B=null,z=null;const it=new le(0,0,K,et),ht=new le(0,0,K,et);let At=!1;const H=new gc;let Q=!1,ct=!1;this.transmissionResolutionScale=1;const k=new oe,rt=new oe,st=new N,Et=new le,yt={background:null,fog:null,environment:null,overrideMaterial:null,isScene:!0};let ot=!1;function Ut(){return O===null?y:1}let A=n;function ne(v,L){return e.getContext(v,L)}try{const v={alpha:!0,depth:r,stencil:s,antialias:o,premultipliedAlpha:c,preserveDrawingBuffer:l,powerPreference:h,failIfMajorPerformanceCaveat:f};if("setAttribute"in e&&e.setAttribute("data-engine",`three.js r${fa}`),e.addEventListener("webglcontextlost",j,!1),e.addEventListener("webglcontextrestored",Mt,!1),e.addEventListener("webglcontextcreationerror",xt,!1),A===null){const L="webgl2";if(A=ne(L,v),A===null)throw ne(L)?new Error("Error creating WebGL context with your selected attributes."):new Error("Error creating WebGL context.")}}catch(v){throw console.error("THREE.WebGLRenderer: "+v.message),v}let Ct,It,pt,Nt,ut,S,_,U,Y,$,X,ft,lt,gt,Lt,nt,dt,wt,Rt,vt,zt,Ht,Qt,P;function mt(){Ct=new md(A),Ct.init(),Ht=new jp(A,Ct),It=new ld(A,Ct,t,Ht),pt=new $p(A,Ct),It.reverseDepthBuffer&&d&&pt.buffers.depth.setReversed(!0),Nt=new vd(A),ut=new Fp,S=new Kp(A,Ct,pt,ut,It,Ht,Nt),_=new hd(T),U=new pd(T),Y=new Tu(A),Qt=new od(A,Y),$=new _d(A,Y,Nt,Qt),X=new Md(A,$,Y,Nt),Rt=new xd(A,It,S),nt=new ud(ut),ft=new Np(T,_,U,Ct,It,Qt,nt),lt=new rm(T,ut),gt=new Bp,Lt=new Wp(Ct),wt=new ad(T,_,U,pt,X,m,c),dt=new Yp(T,X,It),P=new sm(A,Nt,It,pt),vt=new cd(A,Ct,Nt),zt=new gd(A,Ct,Nt),Nt.programs=ft.programs,T.capabilities=It,T.extensions=Ct,T.properties=ut,T.renderLists=gt,T.shadowMap=dt,T.state=pt,T.info=Nt}mt();const q=new nm(T,A);this.xr=q,this.getContext=function(){return A},this.getContextAttributes=function(){return A.getContextAttributes()},this.forceContextLoss=function(){const v=Ct.get("WEBGL_lose_context");v&&v.loseContext()},this.forceContextRestore=function(){const v=Ct.get("WEBGL_lose_context");v&&v.restoreContext()},this.getPixelRatio=function(){return y},this.setPixelRatio=function(v){v!==void 0&&(y=v,this.setSize(K,et,!1))},this.getSize=function(v){return v.set(K,et)},this.setSize=function(v,L,V=!0){if(q.isPresenting){console.warn("THREE.WebGLRenderer: Can't change size while VR device is presenting.");return}K=v,et=L,e.width=Math.floor(v*y),e.height=Math.floor(L*y),V===!0&&(e.style.width=v+"px",e.style.height=L+"px"),this.setViewport(0,0,v,L)},this.getDrawingBufferSize=function(v){return v.set(K*y,et*y).floor()},this.setDrawingBufferSize=function(v,L,V){K=v,et=L,y=V,e.width=Math.floor(v*V),e.height=Math.floor(L*V),this.setViewport(0,0,v,L)},this.getCurrentViewport=function(v){return v.copy(C)},this.getViewport=function(v){return v.copy(it)},this.setViewport=function(v,L,V,G){v.isVector4?it.set(v.x,v.y,v.z,v.w):it.set(v,L,V,G),pt.viewport(C.copy(it).multiplyScalar(y).round())},this.getScissor=function(v){return v.copy(ht)},this.setScissor=function(v,L,V,G){v.isVector4?ht.set(v.x,v.y,v.z,v.w):ht.set(v,L,V,G),pt.scissor(Z.copy(ht).multiplyScalar(y).round())},this.getScissorTest=function(){return At},this.setScissorTest=function(v){pt.setScissorTest(At=v)},this.setOpaqueSort=function(v){B=v},this.setTransparentSort=function(v){z=v},this.getClearColor=function(v){return v.copy(wt.getClearColor())},this.setClearColor=function(){wt.setClearColor.apply(wt,arguments)},this.getClearAlpha=function(){return wt.getClearAlpha()},this.setClearAlpha=function(){wt.setClearAlpha.apply(wt,arguments)},this.clear=function(v=!0,L=!0,V=!0){let G=0;if(v){let I=!1;if(O!==null){const at=O.texture.format;I=at===va||at===ga||at===_a}if(I){const at=O.texture.type,St=at===dn||at===kn||at===Hi||at===Mi||at===pa||at===ma,Tt=wt.getClearColor(),bt=wt.getClearAlpha(),Ft=Tt.r,Bt=Tt.g,Pt=Tt.b;St?(g[0]=Ft,g[1]=Bt,g[2]=Pt,g[3]=bt,A.clearBufferuiv(A.COLOR,0,g)):(x[0]=Ft,x[1]=Bt,x[2]=Pt,x[3]=bt,A.clearBufferiv(A.COLOR,0,x))}else G|=A.COLOR_BUFFER_BIT}L&&(G|=A.DEPTH_BUFFER_BIT),V&&(G|=A.STENCIL_BUFFER_BIT,this.state.buffers.stencil.setMask(4294967295)),A.clear(G)},this.clearColor=function(){this.clear(!0,!1,!1)},this.clearDepth=function(){this.clear(!1,!0,!1)},this.clearStencil=function(){this.clear(!1,!1,!0)},this.dispose=function(){e.removeEventListener("webglcontextlost",j,!1),e.removeEventListener("webglcontextrestored",Mt,!1),e.removeEventListener("webglcontextcreationerror",xt,!1),wt.dispose(),gt.dispose(),Lt.dispose(),ut.dispose(),_.dispose(),U.dispose(),X.dispose(),Qt.dispose(),P.dispose(),ft.dispose(),q.dispose(),q.removeEventListener("sessionstart",Ra),q.removeEventListener("sessionend",Ca),bn.stop()};function j(v){v.preventDefault(),console.log("THREE.WebGLRenderer: Context Lost."),F=!0}function Mt(){console.log("THREE.WebGLRenderer: Context Restored."),F=!1;const v=Nt.autoReset,L=dt.enabled,V=dt.autoUpdate,G=dt.needsUpdate,I=dt.type;mt(),Nt.autoReset=v,dt.enabled=L,dt.autoUpdate=V,dt.needsUpdate=G,dt.type=I}function xt(v){console.error("THREE.WebGLRenderer: A WebGL context could not be created. Reason: ",v.statusMessage)}function Ot(v){const L=v.target;L.removeEventListener("dispose",Ot),ie(L)}function ie(v){fe(v),ut.remove(v)}function fe(v){const L=ut.get(v).programs;L!==void 0&&(L.forEach(function(V){ft.releaseProgram(V)}),v.isShaderMaterial&&ft.releaseShaderCache(v))}this.renderBufferDirect=function(v,L,V,G,I,at){L===null&&(L=yt);const St=I.isMesh&&I.matrixWorld.determinant()<0,Tt=Cc(v,L,V,G,I);pt.setMaterial(G,St);let bt=V.index,Ft=1;if(G.wireframe===!0){if(bt=$.getWireframeAttribute(V),bt===void 0)return;Ft=2}const Bt=V.drawRange,Pt=V.attributes.position;let Yt=Bt.start*Ft,jt=(Bt.start+Bt.count)*Ft;at!==null&&(Yt=Math.max(Yt,at.start*Ft),jt=Math.min(jt,(at.start+at.count)*Ft)),bt!==null?(Yt=Math.max(Yt,0),jt=Math.min(jt,bt.count)):Pt!=null&&(Yt=Math.max(Yt,0),jt=Math.min(jt,Pt.count));const ue=jt-Yt;if(ue<0||ue===1/0)return;Qt.setup(I,G,Tt,V,bt);let ce,Zt=vt;if(bt!==null&&(ce=Y.get(bt),Zt=zt,Zt.setIndex(ce)),I.isMesh)G.wireframe===!0?(pt.setLineWidth(G.wireframeLinewidth*Ut()),Zt.setMode(A.LINES)):Zt.setMode(A.TRIANGLES);else if(I.isLine){let Dt=G.linewidth;Dt===void 0&&(Dt=1),pt.setLineWidth(Dt*Ut()),I.isLineSegments?Zt.setMode(A.LINES):I.isLineLoop?Zt.setMode(A.LINE_LOOP):Zt.setMode(A.LINE_STRIP)}else I.isPoints?Zt.setMode(A.POINTS):I.isSprite&&Zt.setMode(A.TRIANGLES);if(I.isBatchedMesh)if(I._multiDrawInstances!==null)Zt.renderMultiDrawInstances(I._multiDrawStarts,I._multiDrawCounts,I._multiDrawCount,I._multiDrawInstances);else if(Ct.get("WEBGL_multi_draw"))Zt.renderMultiDraw(I._multiDrawStarts,I._multiDrawCounts,I._multiDrawCount);else{const Dt=I._multiDrawStarts,_e=I._multiDrawCounts,Jt=I._multiDrawCount,ze=bt?Y.get(bt).bytesPerElement:1,qn=ut.get(G).currentProgram.getUniforms();for(let Re=0;Re<Jt;Re++)qn.setValue(A,"_gl_DrawID",Re),Zt.render(Dt[Re]/ze,_e[Re])}else if(I.isInstancedMesh)Zt.renderInstances(Yt,ue,I.count);else if(V.isInstancedBufferGeometry){const Dt=V._maxInstanceCount!==void 0?V._maxInstanceCount:1/0,_e=Math.min(V.instanceCount,Dt);Zt.renderInstances(Yt,ue,_e)}else Zt.render(Yt,ue)};function Wt(v,L,V){v.transparent===!0&&v.side===Je&&v.forceSinglePass===!1?(v.side=we,v.needsUpdate=!0,Zi(v,L,V),v.side=Tn,v.needsUpdate=!0,Zi(v,L,V),v.side=Je):Zi(v,L,V)}this.compile=function(v,L,V=null){V===null&&(V=v),u=Lt.get(V),u.init(L),b.push(u),V.traverseVisible(function(I){I.isLight&&I.layers.test(L.layers)&&(u.pushLight(I),I.castShadow&&u.pushShadow(I))}),v!==V&&v.traverseVisible(function(I){I.isLight&&I.layers.test(L.layers)&&(u.pushLight(I),I.castShadow&&u.pushShadow(I))}),u.setupLights();const G=new Set;return v.traverse(function(I){if(!(I.isMesh||I.isPoints||I.isLine||I.isSprite))return;const at=I.material;if(at)if(Array.isArray(at))for(let St=0;St<at.length;St++){const Tt=at[St];Wt(Tt,V,I),G.add(Tt)}else Wt(at,V,I),G.add(at)}),b.pop(),u=null,G},this.compileAsync=function(v,L,V=null){const G=this.compile(v,L,V);return new Promise(I=>{function at(){if(G.forEach(function(St){ut.get(St).currentProgram.isReady()&&G.delete(St)}),G.size===0){I(v);return}setTimeout(at,10)}Ct.get("KHR_parallel_shader_compile")!==null?at():setTimeout(at,10)})};let Be=null;function tn(v){Be&&Be(v)}function Ra(){bn.stop()}function Ca(){bn.start()}const bn=new xc;bn.setAnimationLoop(tn),typeof self<"u"&&bn.setContext(self),this.setAnimationLoop=function(v){Be=v,q.setAnimationLoop(v),v===null?bn.stop():bn.start()},q.addEventListener("sessionstart",Ra),q.addEventListener("sessionend",Ca),this.render=function(v,L){if(L!==void 0&&L.isCamera!==!0){console.error("THREE.WebGLRenderer.render: camera is not an instance of THREE.Camera.");return}if(F===!0)return;if(v.matrixWorldAutoUpdate===!0&&v.updateMatrixWorld(),L.parent===null&&L.matrixWorldAutoUpdate===!0&&L.updateMatrixWorld(),q.enabled===!0&&q.isPresenting===!0&&(q.cameraAutoUpdate===!0&&q.updateCamera(L),L=q.getCamera()),v.isScene===!0&&v.onBeforeRender(T,v,L,O),u=Lt.get(v,b.length),u.init(L),b.push(u),rt.multiplyMatrices(L.projectionMatrix,L.matrixWorldInverse),H.setFromProjectionMatrix(rt),ct=this.localClippingEnabled,Q=nt.init(this.clippingPlanes,ct),p=gt.get(v,w.length),p.init(),w.push(p),q.enabled===!0&&q.isPresenting===!0){const at=T.xr.getDepthSensingMesh();at!==null&&kr(at,L,-1/0,T.sortObjects)}kr(v,L,0,T.sortObjects),p.finish(),T.sortObjects===!0&&p.sort(B,z),ot=q.enabled===!1||q.isPresenting===!1||q.hasDepthSensing()===!1,ot&&wt.addToRenderList(p,v),this.info.render.frame++,Q===!0&&nt.beginShadows();const V=u.state.shadowsArray;dt.render(V,v,L),Q===!0&&nt.endShadows(),this.info.autoReset===!0&&this.info.reset();const G=p.opaque,I=p.transmissive;if(u.setupLights(),L.isArrayCamera){const at=L.cameras;if(I.length>0)for(let St=0,Tt=at.length;St<Tt;St++){const bt=at[St];Da(G,I,v,bt)}ot&&wt.render(v);for(let St=0,Tt=at.length;St<Tt;St++){const bt=at[St];Pa(p,v,bt,bt.viewport)}}else I.length>0&&Da(G,I,v,L),ot&&wt.render(v),Pa(p,v,L);O!==null&&R===0&&(S.updateMultisampleRenderTarget(O),S.updateRenderTargetMipmap(O)),v.isScene===!0&&v.onAfterRender(T,v,L),Qt.resetDefaultState(),E=-1,M=null,b.pop(),b.length>0?(u=b[b.length-1],Q===!0&&nt.setGlobalState(T.clippingPlanes,u.state.camera)):u=null,w.pop(),w.length>0?p=w[w.length-1]:p=null};function kr(v,L,V,G){if(v.visible===!1)return;if(v.layers.test(L.layers)){if(v.isGroup)V=v.renderOrder;else if(v.isLOD)v.autoUpdate===!0&&v.update(L);else if(v.isLight)u.pushLight(v),v.castShadow&&u.pushShadow(v);else if(v.isSprite){if(!v.frustumCulled||H.intersectsSprite(v)){G&&Et.setFromMatrixPosition(v.matrixWorld).applyMatrix4(rt);const St=X.update(v),Tt=v.material;Tt.visible&&p.push(v,St,Tt,V,Et.z,null)}}else if((v.isMesh||v.isLine||v.isPoints)&&(!v.frustumCulled||H.intersectsObject(v))){const St=X.update(v),Tt=v.material;if(G&&(v.boundingSphere!==void 0?(v.boundingSphere===null&&v.computeBoundingSphere(),Et.copy(v.boundingSphere.center)):(St.boundingSphere===null&&St.computeBoundingSphere(),Et.copy(St.boundingSphere.center)),Et.applyMatrix4(v.matrixWorld).applyMatrix4(rt)),Array.isArray(Tt)){const bt=St.groups;for(let Ft=0,Bt=bt.length;Ft<Bt;Ft++){const Pt=bt[Ft],Yt=Tt[Pt.materialIndex];Yt&&Yt.visible&&p.push(v,St,Yt,V,Et.z,Pt)}}else Tt.visible&&p.push(v,St,Tt,V,Et.z,null)}}const at=v.children;for(let St=0,Tt=at.length;St<Tt;St++)kr(at[St],L,V,G)}function Pa(v,L,V,G){const I=v.opaque,at=v.transmissive,St=v.transparent;u.setupLightsView(V),Q===!0&&nt.setGlobalState(T.clippingPlanes,V),G&&pt.viewport(C.copy(G)),I.length>0&&Yi(I,L,V),at.length>0&&Yi(at,L,V),St.length>0&&Yi(St,L,V),pt.buffers.depth.setTest(!0),pt.buffers.depth.setMask(!0),pt.buffers.color.setMask(!0),pt.setPolygonOffset(!1)}function Da(v,L,V,G){if((V.isScene===!0?V.overrideMaterial:null)!==null)return;u.state.transmissionRenderTarget[G.id]===void 0&&(u.state.transmissionRenderTarget[G.id]=new Wn(1,1,{generateMipmaps:!0,type:Ct.has("EXT_color_buffer_half_float")||Ct.has("EXT_color_buffer_float")?Gi:dn,minFilter:Gn,samples:4,stencilBuffer:s,resolveDepthBuffer:!1,resolveStencilBuffer:!1,colorSpace:$t.workingColorSpace}));const at=u.state.transmissionRenderTarget[G.id],St=G.viewport||C;at.setSize(St.z*T.transmissionResolutionScale,St.w*T.transmissionResolutionScale);const Tt=T.getRenderTarget();T.setRenderTarget(at),T.getClearColor(J),tt=T.getClearAlpha(),tt<1&&T.setClearColor(16777215,.5),T.clear(),ot&&wt.render(V);const bt=T.toneMapping;T.toneMapping=yn;const Ft=G.viewport;if(G.viewport!==void 0&&(G.viewport=void 0),u.setupLightsView(G),Q===!0&&nt.setGlobalState(T.clippingPlanes,G),Yi(v,V,G),S.updateMultisampleRenderTarget(at),S.updateRenderTargetMipmap(at),Ct.has("WEBGL_multisampled_render_to_texture")===!1){let Bt=!1;for(let Pt=0,Yt=L.length;Pt<Yt;Pt++){const jt=L[Pt],ue=jt.object,ce=jt.geometry,Zt=jt.material,Dt=jt.group;if(Zt.side===Je&&ue.layers.test(G.layers)){const _e=Zt.side;Zt.side=we,Zt.needsUpdate=!0,La(ue,V,G,ce,Zt,Dt),Zt.side=_e,Zt.needsUpdate=!0,Bt=!0}}Bt===!0&&(S.updateMultisampleRenderTarget(at),S.updateRenderTargetMipmap(at))}T.setRenderTarget(Tt),T.setClearColor(J,tt),Ft!==void 0&&(G.viewport=Ft),T.toneMapping=bt}function Yi(v,L,V){const G=L.isScene===!0?L.overrideMaterial:null;for(let I=0,at=v.length;I<at;I++){const St=v[I],Tt=St.object,bt=St.geometry,Ft=G===null?St.material:G,Bt=St.group;Tt.layers.test(V.layers)&&La(Tt,L,V,bt,Ft,Bt)}}function La(v,L,V,G,I,at){v.onBeforeRender(T,L,V,G,I,at),v.modelViewMatrix.multiplyMatrices(V.matrixWorldInverse,v.matrixWorld),v.normalMatrix.getNormalMatrix(v.modelViewMatrix),I.onBeforeRender(T,L,V,G,v,at),I.transparent===!0&&I.side===Je&&I.forceSinglePass===!1?(I.side=we,I.needsUpdate=!0,T.renderBufferDirect(V,L,G,I,v,at),I.side=Tn,I.needsUpdate=!0,T.renderBufferDirect(V,L,G,I,v,at),I.side=Je):T.renderBufferDirect(V,L,G,I,v,at),v.onAfterRender(T,L,V,G,I,at)}function Zi(v,L,V){L.isScene!==!0&&(L=yt);const G=ut.get(v),I=u.state.lights,at=u.state.shadowsArray,St=I.state.version,Tt=ft.getParameters(v,I.state,at,L,V),bt=ft.getProgramCacheKey(Tt);let Ft=G.programs;G.environment=v.isMeshStandardMaterial?L.environment:null,G.fog=L.fog,G.envMap=(v.isMeshStandardMaterial?U:_).get(v.envMap||G.environment),G.envMapRotation=G.environment!==null&&v.envMap===null?L.environmentRotation:v.envMapRotation,Ft===void 0&&(v.addEventListener("dispose",Ot),Ft=new Map,G.programs=Ft);let Bt=Ft.get(bt);if(Bt!==void 0){if(G.currentProgram===Bt&&G.lightsStateVersion===St)return Ia(v,Tt),Bt}else Tt.uniforms=ft.getUniforms(v),v.onBeforeCompile(Tt,T),Bt=ft.acquireProgram(Tt,bt),Ft.set(bt,Bt),G.uniforms=Tt.uniforms;const Pt=G.uniforms;return(!v.isShaderMaterial&&!v.isRawShaderMaterial||v.clipping===!0)&&(Pt.clippingPlanes=nt.uniform),Ia(v,Tt),G.needsLights=Dc(v),G.lightsStateVersion=St,G.needsLights&&(Pt.ambientLightColor.value=I.state.ambient,Pt.lightProbe.value=I.state.probe,Pt.directionalLights.value=I.state.directional,Pt.directionalLightShadows.value=I.state.directionalShadow,Pt.spotLights.value=I.state.spot,Pt.spotLightShadows.value=I.state.spotShadow,Pt.rectAreaLights.value=I.state.rectArea,Pt.ltc_1.value=I.state.rectAreaLTC1,Pt.ltc_2.value=I.state.rectAreaLTC2,Pt.pointLights.value=I.state.point,Pt.pointLightShadows.value=I.state.pointShadow,Pt.hemisphereLights.value=I.state.hemi,Pt.directionalShadowMap.value=I.state.directionalShadowMap,Pt.directionalShadowMatrix.value=I.state.directionalShadowMatrix,Pt.spotShadowMap.value=I.state.spotShadowMap,Pt.spotLightMatrix.value=I.state.spotLightMatrix,Pt.spotLightMap.value=I.state.spotLightMap,Pt.pointShadowMap.value=I.state.pointShadowMap,Pt.pointShadowMatrix.value=I.state.pointShadowMatrix),G.currentProgram=Bt,G.uniformsList=null,Bt}function Ua(v){if(v.uniformsList===null){const L=v.currentProgram.getUniforms();v.uniformsList=Dr.seqWithValue(L.seq,v.uniforms)}return v.uniformsList}function Ia(v,L){const V=ut.get(v);V.outputColorSpace=L.outputColorSpace,V.batching=L.batching,V.batchingColor=L.batchingColor,V.instancing=L.instancing,V.instancingColor=L.instancingColor,V.instancingMorph=L.instancingMorph,V.skinning=L.skinning,V.morphTargets=L.morphTargets,V.morphNormals=L.morphNormals,V.morphColors=L.morphColors,V.morphTargetsCount=L.morphTargetsCount,V.numClippingPlanes=L.numClippingPlanes,V.numIntersection=L.numClipIntersection,V.vertexAlphas=L.vertexAlphas,V.vertexTangents=L.vertexTangents,V.toneMapping=L.toneMapping}function Cc(v,L,V,G,I){L.isScene!==!0&&(L=yt),S.resetTextureUnits();const at=L.fog,St=G.isMeshStandardMaterial?L.environment:null,Tt=O===null?T.outputColorSpace:O.isXRRenderTarget===!0?O.texture.colorSpace:Ei,bt=(G.isMeshStandardMaterial?U:_).get(G.envMap||St),Ft=G.vertexColors===!0&&!!V.attributes.color&&V.attributes.color.itemSize===4,Bt=!!V.attributes.tangent&&(!!G.normalMap||G.anisotropy>0),Pt=!!V.morphAttributes.position,Yt=!!V.morphAttributes.normal,jt=!!V.morphAttributes.color;let ue=yn;G.toneMapped&&(O===null||O.isXRRenderTarget===!0)&&(ue=T.toneMapping);const ce=V.morphAttributes.position||V.morphAttributes.normal||V.morphAttributes.color,Zt=ce!==void 0?ce.length:0,Dt=ut.get(G),_e=u.state.lights;if(Q===!0&&(ct===!0||v!==M)){const Me=v===M&&G.id===E;nt.setState(G,v,Me)}let Jt=!1;G.version===Dt.__version?(Dt.needsLights&&Dt.lightsStateVersion!==_e.state.version||Dt.outputColorSpace!==Tt||I.isBatchedMesh&&Dt.batching===!1||!I.isBatchedMesh&&Dt.batching===!0||I.isBatchedMesh&&Dt.batchingColor===!0&&I.colorTexture===null||I.isBatchedMesh&&Dt.batchingColor===!1&&I.colorTexture!==null||I.isInstancedMesh&&Dt.instancing===!1||!I.isInstancedMesh&&Dt.instancing===!0||I.isSkinnedMesh&&Dt.skinning===!1||!I.isSkinnedMesh&&Dt.skinning===!0||I.isInstancedMesh&&Dt.instancingColor===!0&&I.instanceColor===null||I.isInstancedMesh&&Dt.instancingColor===!1&&I.instanceColor!==null||I.isInstancedMesh&&Dt.instancingMorph===!0&&I.morphTexture===null||I.isInstancedMesh&&Dt.instancingMorph===!1&&I.morphTexture!==null||Dt.envMap!==bt||G.fog===!0&&Dt.fog!==at||Dt.numClippingPlanes!==void 0&&(Dt.numClippingPlanes!==nt.numPlanes||Dt.numIntersection!==nt.numIntersection)||Dt.vertexAlphas!==Ft||Dt.vertexTangents!==Bt||Dt.morphTargets!==Pt||Dt.morphNormals!==Yt||Dt.morphColors!==jt||Dt.toneMapping!==ue||Dt.morphTargetsCount!==Zt)&&(Jt=!0):(Jt=!0,Dt.__version=G.version);let ze=Dt.currentProgram;Jt===!0&&(ze=Zi(G,L,I));let qn=!1,Re=!1,bi=!1;const ae=ze.getUniforms(),Ue=Dt.uniforms;if(pt.useProgram(ze.program)&&(qn=!0,Re=!0,bi=!0),G.id!==E&&(E=G.id,Re=!0),qn||M!==v){pt.buffers.depth.getReversed()?(k.copy(v.projectionMatrix),Vl(k),Gl(k),ae.setValue(A,"projectionMatrix",k)):ae.setValue(A,"projectionMatrix",v.projectionMatrix),ae.setValue(A,"viewMatrix",v.matrixWorldInverse);const Ae=ae.map.cameraPosition;Ae!==void 0&&Ae.setValue(A,st.setFromMatrixPosition(v.matrixWorld)),It.logarithmicDepthBuffer&&ae.setValue(A,"logDepthBufFC",2/(Math.log(v.far+1)/Math.LN2)),(G.isMeshPhongMaterial||G.isMeshToonMaterial||G.isMeshLambertMaterial||G.isMeshBasicMaterial||G.isMeshStandardMaterial||G.isShaderMaterial)&&ae.setValue(A,"isOrthographic",v.isOrthographicCamera===!0),M!==v&&(M=v,Re=!0,bi=!0)}if(I.isSkinnedMesh){ae.setOptional(A,I,"bindMatrix"),ae.setOptional(A,I,"bindMatrixInverse");const Me=I.skeleton;Me&&(Me.boneTexture===null&&Me.computeBoneTexture(),ae.setValue(A,"boneTexture",Me.boneTexture,S))}I.isBatchedMesh&&(ae.setOptional(A,I,"batchingTexture"),ae.setValue(A,"batchingTexture",I._matricesTexture,S),ae.setOptional(A,I,"batchingIdTexture"),ae.setValue(A,"batchingIdTexture",I._indirectTexture,S),ae.setOptional(A,I,"batchingColorTexture"),I._colorsTexture!==null&&ae.setValue(A,"batchingColorTexture",I._colorsTexture,S));const Ie=V.morphAttributes;if((Ie.position!==void 0||Ie.normal!==void 0||Ie.color!==void 0)&&Rt.update(I,V,ze),(Re||Dt.receiveShadow!==I.receiveShadow)&&(Dt.receiveShadow=I.receiveShadow,ae.setValue(A,"receiveShadow",I.receiveShadow)),G.isMeshGouraudMaterial&&G.envMap!==null&&(Ue.envMap.value=bt,Ue.flipEnvMap.value=bt.isCubeTexture&&bt.isRenderTargetTexture===!1?-1:1),G.isMeshStandardMaterial&&G.envMap===null&&L.environment!==null&&(Ue.envMapIntensity.value=L.environmentIntensity),Re&&(ae.setValue(A,"toneMappingExposure",T.toneMappingExposure),Dt.needsLights&&Pc(Ue,bi),at&&G.fog===!0&&lt.refreshFogUniforms(Ue,at),lt.refreshMaterialUniforms(Ue,G,y,et,u.state.transmissionRenderTarget[v.id]),Dr.upload(A,Ua(Dt),Ue,S)),G.isShaderMaterial&&G.uniformsNeedUpdate===!0&&(Dr.upload(A,Ua(Dt),Ue,S),G.uniformsNeedUpdate=!1),G.isSpriteMaterial&&ae.setValue(A,"center",I.center),ae.setValue(A,"modelViewMatrix",I.modelViewMatrix),ae.setValue(A,"normalMatrix",I.normalMatrix),ae.setValue(A,"modelMatrix",I.matrixWorld),G.isShaderMaterial||G.isRawShaderMaterial){const Me=G.uniformsGroups;for(let Ae=0,Wr=Me.length;Ae<Wr;Ae++){const wn=Me[Ae];P.update(wn,ze),P.bind(wn,ze)}}return ze}function Pc(v,L){v.ambientLightColor.needsUpdate=L,v.lightProbe.needsUpdate=L,v.directionalLights.needsUpdate=L,v.directionalLightShadows.needsUpdate=L,v.pointLights.needsUpdate=L,v.pointLightShadows.needsUpdate=L,v.spotLights.needsUpdate=L,v.spotLightShadows.needsUpdate=L,v.rectAreaLights.needsUpdate=L,v.hemisphereLights.needsUpdate=L}function Dc(v){return v.isMeshLambertMaterial||v.isMeshToonMaterial||v.isMeshPhongMaterial||v.isMeshStandardMaterial||v.isShadowMaterial||v.isShaderMaterial&&v.lights===!0}this.getActiveCubeFace=function(){return D},this.getActiveMipmapLevel=function(){return R},this.getRenderTarget=function(){return O},this.setRenderTargetTextures=function(v,L,V){ut.get(v.texture).__webglTexture=L,ut.get(v.depthTexture).__webglTexture=V;const G=ut.get(v);G.__hasExternalTextures=!0,G.__autoAllocateDepthBuffer=V===void 0,G.__autoAllocateDepthBuffer||Ct.has("WEBGL_multisampled_render_to_texture")===!0&&(console.warn("THREE.WebGLRenderer: Render-to-texture extension was disabled because an external texture was provided"),G.__useRenderToTexture=!1)},this.setRenderTargetFramebuffer=function(v,L){const V=ut.get(v);V.__webglFramebuffer=L,V.__useDefaultFramebuffer=L===void 0};const Lc=A.createFramebuffer();this.setRenderTarget=function(v,L=0,V=0){O=v,D=L,R=V;let G=!0,I=null,at=!1,St=!1;if(v){const bt=ut.get(v);if(bt.__useDefaultFramebuffer!==void 0)pt.bindFramebuffer(A.FRAMEBUFFER,null),G=!1;else if(bt.__webglFramebuffer===void 0)S.setupRenderTarget(v);else if(bt.__hasExternalTextures)S.rebindTextures(v,ut.get(v.texture).__webglTexture,ut.get(v.depthTexture).__webglTexture);else if(v.depthBuffer){const Pt=v.depthTexture;if(bt.__boundDepthTexture!==Pt){if(Pt!==null&&ut.has(Pt)&&(v.width!==Pt.image.width||v.height!==Pt.image.height))throw new Error("WebGLRenderTarget: Attached DepthTexture is initialized to the incorrect size.");S.setupDepthRenderbuffer(v)}}const Ft=v.texture;(Ft.isData3DTexture||Ft.isDataArrayTexture||Ft.isCompressedArrayTexture)&&(St=!0);const Bt=ut.get(v).__webglFramebuffer;v.isWebGLCubeRenderTarget?(Array.isArray(Bt[L])?I=Bt[L][V]:I=Bt[L],at=!0):v.samples>0&&S.useMultisampledRTT(v)===!1?I=ut.get(v).__webglMultisampledFramebuffer:Array.isArray(Bt)?I=Bt[V]:I=Bt,C.copy(v.viewport),Z.copy(v.scissor),W=v.scissorTest}else C.copy(it).multiplyScalar(y).floor(),Z.copy(ht).multiplyScalar(y).floor(),W=At;if(V!==0&&(I=Lc),pt.bindFramebuffer(A.FRAMEBUFFER,I)&&G&&pt.drawBuffers(v,I),pt.viewport(C),pt.scissor(Z),pt.setScissorTest(W),at){const bt=ut.get(v.texture);A.framebufferTexture2D(A.FRAMEBUFFER,A.COLOR_ATTACHMENT0,A.TEXTURE_CUBE_MAP_POSITIVE_X+L,bt.__webglTexture,V)}else if(St){const bt=ut.get(v.texture),Ft=L;A.framebufferTextureLayer(A.FRAMEBUFFER,A.COLOR_ATTACHMENT0,bt.__webglTexture,V,Ft)}else if(v!==null&&V!==0){const bt=ut.get(v.texture);A.framebufferTexture2D(A.FRAMEBUFFER,A.COLOR_ATTACHMENT0,A.TEXTURE_2D,bt.__webglTexture,V)}E=-1},this.readRenderTargetPixels=function(v,L,V,G,I,at,St){if(!(v&&v.isWebGLRenderTarget)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");return}let Tt=ut.get(v).__webglFramebuffer;if(v.isWebGLCubeRenderTarget&&St!==void 0&&(Tt=Tt[St]),Tt){pt.bindFramebuffer(A.FRAMEBUFFER,Tt);try{const bt=v.texture,Ft=bt.format,Bt=bt.type;if(!It.textureFormatReadable(Ft)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not in RGBA or implementation defined format.");return}if(!It.textureTypeReadable(Bt)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not in UnsignedByteType or implementation defined type.");return}L>=0&&L<=v.width-G&&V>=0&&V<=v.height-I&&A.readPixels(L,V,G,I,Ht.convert(Ft),Ht.convert(Bt),at)}finally{const bt=O!==null?ut.get(O).__webglFramebuffer:null;pt.bindFramebuffer(A.FRAMEBUFFER,bt)}}},this.readRenderTargetPixelsAsync=async function(v,L,V,G,I,at,St){if(!(v&&v.isWebGLRenderTarget))throw new Error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");let Tt=ut.get(v).__webglFramebuffer;if(v.isWebGLCubeRenderTarget&&St!==void 0&&(Tt=Tt[St]),Tt){const bt=v.texture,Ft=bt.format,Bt=bt.type;if(!It.textureFormatReadable(Ft))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in RGBA or implementation defined format.");if(!It.textureTypeReadable(Bt))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in UnsignedByteType or implementation defined type.");if(L>=0&&L<=v.width-G&&V>=0&&V<=v.height-I){pt.bindFramebuffer(A.FRAMEBUFFER,Tt);const Pt=A.createBuffer();A.bindBuffer(A.PIXEL_PACK_BUFFER,Pt),A.bufferData(A.PIXEL_PACK_BUFFER,at.byteLength,A.STREAM_READ),A.readPixels(L,V,G,I,Ht.convert(Ft),Ht.convert(Bt),0);const Yt=O!==null?ut.get(O).__webglFramebuffer:null;pt.bindFramebuffer(A.FRAMEBUFFER,Yt);const jt=A.fenceSync(A.SYNC_GPU_COMMANDS_COMPLETE,0);return A.flush(),await Hl(A,jt,4),A.bindBuffer(A.PIXEL_PACK_BUFFER,Pt),A.getBufferSubData(A.PIXEL_PACK_BUFFER,0,at),A.deleteBuffer(Pt),A.deleteSync(jt),at}else throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: requested read bounds are out of range.")}},this.copyFramebufferToTexture=function(v,L=null,V=0){v.isTexture!==!0&&(fi("WebGLRenderer: copyFramebufferToTexture function signature has changed."),L=arguments[0]||null,v=arguments[1]);const G=Math.pow(2,-V),I=Math.floor(v.image.width*G),at=Math.floor(v.image.height*G),St=L!==null?L.x:0,Tt=L!==null?L.y:0;S.setTexture2D(v,0),A.copyTexSubImage2D(A.TEXTURE_2D,V,0,0,St,Tt,I,at),pt.unbindTexture()};const Uc=A.createFramebuffer(),Ic=A.createFramebuffer();this.copyTextureToTexture=function(v,L,V=null,G=null,I=0,at=null){v.isTexture!==!0&&(fi("WebGLRenderer: copyTextureToTexture function signature has changed."),G=arguments[0]||null,v=arguments[1],L=arguments[2],at=arguments[3]||0,V=null),at===null&&(I!==0?(fi("WebGLRenderer: copyTextureToTexture function signature has changed to support src and dst mipmap levels."),at=I,I=0):at=0);let St,Tt,bt,Ft,Bt,Pt,Yt,jt,ue;const ce=v.isCompressedTexture?v.mipmaps[at]:v.image;if(V!==null)St=V.max.x-V.min.x,Tt=V.max.y-V.min.y,bt=V.isBox3?V.max.z-V.min.z:1,Ft=V.min.x,Bt=V.min.y,Pt=V.isBox3?V.min.z:0;else{const Ie=Math.pow(2,-I);St=Math.floor(ce.width*Ie),Tt=Math.floor(ce.height*Ie),v.isDataArrayTexture?bt=ce.depth:v.isData3DTexture?bt=Math.floor(ce.depth*Ie):bt=1,Ft=0,Bt=0,Pt=0}G!==null?(Yt=G.x,jt=G.y,ue=G.z):(Yt=0,jt=0,ue=0);const Zt=Ht.convert(L.format),Dt=Ht.convert(L.type);let _e;L.isData3DTexture?(S.setTexture3D(L,0),_e=A.TEXTURE_3D):L.isDataArrayTexture||L.isCompressedArrayTexture?(S.setTexture2DArray(L,0),_e=A.TEXTURE_2D_ARRAY):(S.setTexture2D(L,0),_e=A.TEXTURE_2D),A.pixelStorei(A.UNPACK_FLIP_Y_WEBGL,L.flipY),A.pixelStorei(A.UNPACK_PREMULTIPLY_ALPHA_WEBGL,L.premultiplyAlpha),A.pixelStorei(A.UNPACK_ALIGNMENT,L.unpackAlignment);const Jt=A.getParameter(A.UNPACK_ROW_LENGTH),ze=A.getParameter(A.UNPACK_IMAGE_HEIGHT),qn=A.getParameter(A.UNPACK_SKIP_PIXELS),Re=A.getParameter(A.UNPACK_SKIP_ROWS),bi=A.getParameter(A.UNPACK_SKIP_IMAGES);A.pixelStorei(A.UNPACK_ROW_LENGTH,ce.width),A.pixelStorei(A.UNPACK_IMAGE_HEIGHT,ce.height),A.pixelStorei(A.UNPACK_SKIP_PIXELS,Ft),A.pixelStorei(A.UNPACK_SKIP_ROWS,Bt),A.pixelStorei(A.UNPACK_SKIP_IMAGES,Pt);const ae=v.isDataArrayTexture||v.isData3DTexture,Ue=L.isDataArrayTexture||L.isData3DTexture;if(v.isDepthTexture){const Ie=ut.get(v),Me=ut.get(L),Ae=ut.get(Ie.__renderTarget),Wr=ut.get(Me.__renderTarget);pt.bindFramebuffer(A.READ_FRAMEBUFFER,Ae.__webglFramebuffer),pt.bindFramebuffer(A.DRAW_FRAMEBUFFER,Wr.__webglFramebuffer);for(let wn=0;wn<bt;wn++)ae&&(A.framebufferTextureLayer(A.READ_FRAMEBUFFER,A.COLOR_ATTACHMENT0,ut.get(v).__webglTexture,I,Pt+wn),A.framebufferTextureLayer(A.DRAW_FRAMEBUFFER,A.COLOR_ATTACHMENT0,ut.get(L).__webglTexture,at,ue+wn)),A.blitFramebuffer(Ft,Bt,St,Tt,Yt,jt,St,Tt,A.DEPTH_BUFFER_BIT,A.NEAREST);pt.bindFramebuffer(A.READ_FRAMEBUFFER,null),pt.bindFramebuffer(A.DRAW_FRAMEBUFFER,null)}else if(I!==0||v.isRenderTargetTexture||ut.has(v)){const Ie=ut.get(v),Me=ut.get(L);pt.bindFramebuffer(A.READ_FRAMEBUFFER,Uc),pt.bindFramebuffer(A.DRAW_FRAMEBUFFER,Ic);for(let Ae=0;Ae<bt;Ae++)ae?A.framebufferTextureLayer(A.READ_FRAMEBUFFER,A.COLOR_ATTACHMENT0,Ie.__webglTexture,I,Pt+Ae):A.framebufferTexture2D(A.READ_FRAMEBUFFER,A.COLOR_ATTACHMENT0,A.TEXTURE_2D,Ie.__webglTexture,I),Ue?A.framebufferTextureLayer(A.DRAW_FRAMEBUFFER,A.COLOR_ATTACHMENT0,Me.__webglTexture,at,ue+Ae):A.framebufferTexture2D(A.DRAW_FRAMEBUFFER,A.COLOR_ATTACHMENT0,A.TEXTURE_2D,Me.__webglTexture,at),I!==0?A.blitFramebuffer(Ft,Bt,St,Tt,Yt,jt,St,Tt,A.COLOR_BUFFER_BIT,A.NEAREST):Ue?A.copyTexSubImage3D(_e,at,Yt,jt,ue+Ae,Ft,Bt,St,Tt):A.copyTexSubImage2D(_e,at,Yt,jt,Ft,Bt,St,Tt);pt.bindFramebuffer(A.READ_FRAMEBUFFER,null),pt.bindFramebuffer(A.DRAW_FRAMEBUFFER,null)}else Ue?v.isDataTexture||v.isData3DTexture?A.texSubImage3D(_e,at,Yt,jt,ue,St,Tt,bt,Zt,Dt,ce.data):L.isCompressedArrayTexture?A.compressedTexSubImage3D(_e,at,Yt,jt,ue,St,Tt,bt,Zt,ce.data):A.texSubImage3D(_e,at,Yt,jt,ue,St,Tt,bt,Zt,Dt,ce):v.isDataTexture?A.texSubImage2D(A.TEXTURE_2D,at,Yt,jt,St,Tt,Zt,Dt,ce.data):v.isCompressedTexture?A.compressedTexSubImage2D(A.TEXTURE_2D,at,Yt,jt,ce.width,ce.height,Zt,ce.data):A.texSubImage2D(A.TEXTURE_2D,at,Yt,jt,St,Tt,Zt,Dt,ce);A.pixelStorei(A.UNPACK_ROW_LENGTH,Jt),A.pixelStorei(A.UNPACK_IMAGE_HEIGHT,ze),A.pixelStorei(A.UNPACK_SKIP_PIXELS,qn),A.pixelStorei(A.UNPACK_SKIP_ROWS,Re),A.pixelStorei(A.UNPACK_SKIP_IMAGES,bi),at===0&&L.generateMipmaps&&A.generateMipmap(_e),pt.unbindTexture()},this.copyTextureToTexture3D=function(v,L,V=null,G=null,I=0){return v.isTexture!==!0&&(fi("WebGLRenderer: copyTextureToTexture3D function signature has changed."),V=arguments[0]||null,G=arguments[1]||null,v=arguments[2],L=arguments[3],I=arguments[4]||0),fi('WebGLRenderer: copyTextureToTexture3D function has been deprecated. Use "copyTextureToTexture" instead.'),this.copyTextureToTexture(v,L,V,G,I)},this.initRenderTarget=function(v){ut.get(v).__webglFramebuffer===void 0&&S.setupRenderTarget(v)},this.initTexture=function(v){v.isCubeTexture?S.setTextureCube(v,0):v.isData3DTexture?S.setTexture3D(v,0):v.isDataArrayTexture||v.isCompressedArrayTexture?S.setTexture2DArray(v,0):S.setTexture2D(v,0),pt.unbindTexture()},this.resetState=function(){D=0,R=0,O=null,pt.reset(),Qt.reset()},typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}get coordinateSystem(){return un}get outputColorSpace(){return this._outputColorSpace}set outputColorSpace(t){this._outputColorSpace=t;const e=this.getContext();e.drawingBufferColorspace=$t._getDrawingBufferColorSpace(t),e.unpackColorSpace=$t._getUnpackColorSpace()}}/**
...
lucide.createIcons({icons});\``);if(typeof document>"u")throw new Error("`createIcons()` only works in a browser environment.");const n=document.querySelectorAll(`[${t}]`);if(Array.from(n).forEach(r=>zo(r,{nameAttr:t,icons:i,attrs:e})),t==="data-lucide"){const r=document.querySelectorAll("[icon-name]");r.length>0&&(console.warn("[Lucide] Some icons were found with the now deprecated icon-name attribute. These will still be replaced for backwards compatibility, but will no longer be supported in v1.0 and you should switch to data-lucide"),Array.from(r).forEach(s=>zo(s,{nameAttr:"icon-name",icons:i,attrs:e})))}};function Ho(i,t,e,n){return Math.sin(e*Math.PI*i)*Math.sin(n*Math.PI*t)-Math.sin(n*Math.PI*i)*Math.sin(e*Math.PI*t)}function fm(i,t,e,n,r,s){return Math.sin(n*Math.PI*i)*Math.sin(r*Math.PI*t)+Math.sin(r*Math.PI*t)*Math.sin(s*Math.PI*e)+Math.sin(s*Math.PI*e)*Math.sin(n*Math.PI*i)}const Lr=30,Hn=6.4,dm=Math.round(Hn*Lr),Bi=4.3,Vo=6.38,Go=[[0,1],[0,2],[0,3]],Ss=[{start:0,end:1.35,nodes:[7,0,2,5]},{start:1.35,end:2.45,nodes:[3,1,4,10]},{start:2.45,end:3.45,nodes:[7,5,6,11]},{start:3.45,end:Bi,nodes:[3,8,9,10]},{start:Bi,end:Hn,nodes:[7,0,2,5]}],pm=[{start:.14,end:2,text:"很久以前，宇宙是一锅"},{start:2,end:4.3,text:"滚烫的等离子体——"},{start:4.3,end:6.38,text:"声波，在其中来回震荡。"}];function mm(i){var t;return((t=pm.find(e=>i>=e.start&&i<e.end))==null?void 0:t.text)??""}function ko(i){return Ss.find(t=>i>=t.start&&i<t.end)??Ss[Ss.length-1]}function _m(i,t,e,n){const r=Math.floor(Math.max(0,i)/.55),s=new Set([t[r%t.length]]);return r%3===1&&s.add(t[(r+2)%t.length]),r%4===2&&s.add((r*5+1)%e),{main:[...s],minor:r%2===0?r*3%n:null}}function gm(i){return Wo(i,.85,1.6)+Wo(i,2.75,3.55)}function Wo(i,t,e){const n=Math.min(1,Math.max(0,(i-t)/(e-t)));return n*n*(3-2*n)}function vm(i){if(i<Bi||i>=Vo)return{active:!1,progress:0,radius:0};const t=(i-Bi)/(Vo-Bi);return{active:!0,progress:t,radius:.06+Math.sin(t*Math.PI)*.03}}const Ee=[16777180,16762677,16741400,16723724,9245191],Es=12183295,ke=document.querySelector("#narration"),ha=document.querySelector("#scene"),Xo=document.querySelector("#labels"),xm=document.querySelector("#subtitle"),Mm=document.querySelector("#caption"),Sm=document.querySelector("#timecode"),Ar=document.querySelector("#play"),Em=document.querySelector("#reset");Rc({icons:{Play:bc,Pause:Ac,RotateCcw:wc}});const zi=new am({canvas:ha,antialias:!0,powerPreference:"high-performance"});zi.setClearColor(132103,1);zi.outputColorSpace=be;const wa=new hu;wa.fog=new Sa(132103,.012);const Ke=new Fe(43,1,.1,100);Ke.position.set(0,.1,12.5);Ke.lookAt(0,0,0);const cn=new De;wa.add(cn);async function ym(){const i=m(),t=await g(),e=x();cn.add(e);const n=[{label:"太阳",latin:"SUN",position:[-3.35,1.42,.4],radius:.62,color:Ee[1],spin:.42,phase:.2},{label:"木星",latin:"JUPITER",position:[-1.82,-1.55,.5],radius:.56,color:Ee[2],spin:-.36,phase:1.2},{label:"天狼星",latin:"SIRIUS",position:[.18,1.72,-.4],radius:.51,color:Ee[0],spin:.32,phase:2.1},{label:"土星",latin:"SATURN",position:[2.16,-1.08,.8],radius:.5,color:Ee[2],spin:.29,phase:1.6},{label:"北极星",latin:"POLARIS",position:[3.18,1.92,-.3],radius:.4,color:Ee[0],spin:-.25,phase:.4},{label:"火星",latin:"MARS",position:[1.16,.08,1.05],radius:.42,color:Ee[3],spin:.48,phase:2.8},{label:"参宿四",latin:"BETELGEUSE",position:[-3.28,-1.9,-.8],radius:.55,color:Ee[3],spin:-.31,phase:2.7},{label:"昴星团",latin:"PLEIADES",position:[-.74,.05,-1.22],radius:.64,color:Ee[0],spin:.39,phase:1.9,shape:"chladni",modes:[2,3,4],boundary:"volume",network:!0},{label:"金星",latin:"VENUS",position:[-.12,-2.55,-.95],radius:.44,color:Ee[1],spin:-.44,phase:.9},{label:"海王星",latin:"NEPTUNE",position:[3.62,-2.02,.58],radius:.46,color:Ee[2],spin:.35,phase:2.4},{label:"月球",latin:"MOON",position:[-4.02,.05,-1.2],radius:.3,color:Ee[1],spin:-.52,phase:1.3},{label:"脉冲星",latin:"PULSAR",position:[3.78,.44,-1.48],radius:.5,color:14478591,spin:.7,phase:3.1,shape:"chladni",modes:[2,3,4],boundary:"volume",network:!0}],r=n.map((y,B)=>p(y,B));r.forEach(y=>cn.add(y.group));const s=[{label:"织女星",latin:"VEGA",position:[-4.35,2.42,-1.7],scale:.12},{label:"牛郎星",latin:"ALTAIR",position:[-2.15,2.68,-1.25],scale:.1},{label:"参宿七",latin:"RIGEL",position:[1.35,2.55,-2.1],scale:.11},{label:"五车二",latin:"CAPELLA",position:[4.35,2.35,-1.35],scale:.1},{label:"毕宿五",latin:"ALDEBARAN",position:[-4.55,-1.02,-1.8],scale:.09},{label:"角宿一",latin:"SPICA",position:[-2.28,-.18,-2.25],scale:.09},{label:"心宿二",latin:"ANTARES",position:[2.82,.72,-1.95],scale:.11},{label:"老人星",latin:"CANOPUS",position:[4.24,-2.58,-1.55],scale:.1}],a=s.map((y,B)=>T(y,B));a.forEach(y=>cn.add(y.group));const o=Go.map(()=>F());o.forEach(y=>cn.add(y));const c=D();cn.add(c.group);const l=n.map(y=>{const B=document.createElement("div");return B.className="node-label",B.innerHTML=`${y.label}<small>${y.latin}</small>`,Xo.appendChild(B),B}),h=s.map(y=>{const B=document.createElement("div");return B.className="node-label minor-label",B.innerHTML=`${y.label}<small>${y.latin}</small>`,Xo.appendChild(B),B});let f=!1,d=-1;function m(){const B=document.createElement("canvas");B.width=64,B.height=64;const z=B.getContext("2d"),it=z.createRadialGradient(64/2,64/2,0,64/2,64/2,64/2);it.addColorStop(0,"rgba(255,255,255,1)"),it.addColorStop(.18,"rgba(255,255,255,0.95)"),it.addColorStop(.55,"rgba(255,255,255,0.28)"),it.addColorStop(1,"rgba(255,255,255,0)"),z.fillStyle=it,z.fillRect(0,0,64,64);const ht=new _u(B);return ht.colorSpace=be,ht}async function g(){try{const y=await fetch("/chladni-reference.bin");return y.ok?new Float32Array(await y.arrayBuffer()):null}catch{return null}}function x(){const y=new De,B=[{center:[-4.2,1.55,-2.1],spread:[1.45,.85,1.1]},{center:[-1.55,.25,-2.5],spread:[1.3,1.25,1.25]},{center:[2.15,1.45,-2.2],spread:[1.55,.95,1.2]},{center:[4.05,-1.15,-2.5],spread:[1.25,1.05,1.15]},{center:[-.35,-2.15,-2.15],spread:[1.75,.72,1.3]},{center:[-3.55,-1.8,-1.75],spread:[1.15,.92,1.1]}];let z=17;const it=()=>(z=z*16807%2147483647,z/2147483647),ht=()=>{const At=Math.max(it(),1e-4);return Math.sqrt(-2*Math.log(At))*Math.cos(Math.PI*2*it())};return[{count:1050,size:.042,opacity:.56},{count:420,size:.078,opacity:.72},{count:120,size:.13,opacity:.64}].forEach(At=>{const H=[],Q=[];for(let k=0;k<At.count;k+=1){let rt,st,Et;if(it()<.82){const ot=B[Math.floor(it()*B.length)];rt=ot.center[0]+ht()*ot.spread[0],st=ot.center[1]+ht()*ot.spread[1],Et=ot.center[2]+ht()*ot.spread[2]}else rt=(it()*2-1)*6.2,st=(it()*2-1)*3.6,Et=it()*4.5-4;H.push(Ki.clamp(rt,-6.7,6.7),Ki.clamp(st,-3.9,3.9),Ki.clamp(Et,-5.2,1.2));const yt=.62+it()*.38;Q.push(yt*.82,yt*.88,yt)}const ct=new se;ct.setAttribute("position",new Kt(H,3)),ct.setAttribute("color",new Kt(Q,3)),y.add(new $e(ct,new We({size:At.size,map:i,vertexColors:!0,transparent:!0,opacity:At.opacity,depthWrite:!1,blending:re,sizeAttenuation:!0})))}),y}function p(y,B){if(y.shape==="chladni"&&y.boundary==="volume")return w(y,B);if(y.shape==="chladni")return u(y,B);const z=new De,it=new ui(new In({map:i,color:y.color,transparent:!0,opacity:.2,depthWrite:!1,blending:re}));it.scale.setScalar(y.radius*3.4),z.add(it);const ht=new ui(new In({map:i,color:y.color,transparent:!0,opacity:.42,depthWrite:!1,blending:re}));ht.scale.setScalar(y.radius*1.65),z.add(ht);const At=new ui(new In({map:i,color:Ee[0],transparent:!0,opacity:.92,depthWrite:!1,blending:re}));At.scale.setScalar(y.radius*.68),z.add(At);const H=new se,Q=[],ct=[],k=360+B%4*60,rt=new kt(y.color);for(let ot=0;ot<k;ot+=1){const Ut=ot%3,A=ot*2.39996323+y.phase,ne=Math.acos(1-2*((ot+.5)/k)),Ct=y.radius*(.38+Ut*.28+.06*Math.sin(ot*1.7+y.phase)),It=.78+.18*Math.sin(ot*.37+y.phase),pt=1+.12*Math.sin(A*2.4+Ut);Q.push(Math.cos(A)*Math.sin(ne)*Ct*pt,Math.cos(ne)*Ct*It,Math.sin(A)*Math.sin(ne)*Ct*.68);const Nt=new kt(Ee[Math.min(Ut+1,Ee.length-1)]).lerp(rt,.22),ut=.7+.38*((Math.sin(A*1.7)+1)/2);ct.push(Nt.r*ut,Nt.g*ut,Nt.b*ut)}H.setAttribute("position",new Kt(Q,3)),H.setAttribute("color",new Kt(ct,3));const st=new $e(H,new We({size:.056,map:i,vertexColors:!0,transparent:!0,opacity:.66,depthWrite:!1,blending:re,sizeAttenuation:!0}));z.add(st);const Et=new Ta(y.radius*.88,.006,4,64),yt=new Ye(Et,new Fr({color:y.color,transparent:!0,opacity:.22,blending:re,depthWrite:!1}));return yt.rotation.x=Math.PI*.45+y.phase*.1,yt.rotation.z=y.phase,z.add(yt),z.position.set(...y.position),z.userData={...y,halo:it,mantle:ht,core:At,particles:st,ring:yt,index:B},{group:z,definition:y}}function u(y,B){const z=new De,it=[],ht=[],At=new Map,H=76,Q=.115,[ct,k]=y.modes,rt=new kt(y.color),st=new kt(Ee[0]);for(let pt=0;pt<H;pt+=1)for(let Nt=0;Nt<H;Nt+=1){const ut=Nt/(H-1)*2-1,S=pt/(H-1)*2-1,_=Ho(ut,S,ct,k);if(Math.abs(_)>Q)continue;const U=1-Math.abs(_)/Q,Y=Math.sin((pt*83+Nt*47+B*29)*.17)*.008,$=[(ut+Y)*y.radius*1.25,(S-Y*.6)*y.radius*1.25,_*y.radius*1.7+Math.sin((ut-S)*Math.PI*(ct+k))*y.radius*.035];it.push(...$),At.set(pt*H+Nt,$);const X=rt.clone().lerp(st,.28+U*.66);ht.push(X.r,X.g,X.b)}const Et=new se;Et.setAttribute("position",new Kt(it,3)),Et.setAttribute("color",new Kt(ht,3));const yt=new $e(Et,new We({size:.12,map:i,color:y.color,transparent:!0,opacity:.14,depthWrite:!1,blending:re,sizeAttenuation:!0}));z.add(yt);const ot=new $e(Et,new We({size:.047,map:i,vertexColors:!0,transparent:!0,opacity:.72,depthWrite:!1,blending:re,sizeAttenuation:!0}));z.add(ot);let Ut=null;if(y.network){const pt=[],Nt=[[0,1],[1,0],[1,1],[1,-1]];At.forEach((S,_)=>{const U=Math.floor(_/H),Y=_%H;Nt.forEach(([$,X])=>{const ft=At.get((U+$)*H+Y+X);ft&&pt.push(...S,...ft)})});const ut=new se;ut.setAttribute("position",new Kt(pt,3)),Ut=new xr(ut,new Bn({color:y.color,transparent:!0,opacity:.16,depthWrite:!1,blending:re})),z.add(Ut)}const A=y.radius*1.3,ne=y.boundary==="octagon"?Array.from({length:8},(pt,Nt)=>{const ut=Math.PI/8+Nt*Math.PI/4,S=A/Math.cos(Math.PI/8);return new N(Math.cos(ut)*S,Math.sin(ut)*S,0)}):[new N(-A,-A,0),new N(A,-A,0),new N(A,A,0),new N(-A,A,0)],Ct=new se().setFromPoints(ne),It=new mu(Ct,new Bn({color:y.color,transparent:!0,opacity:.13,depthWrite:!1,blending:re}));return z.add(It),z.position.set(...y.position),z.userData={...y,isChladni:!0,pattern:ot,glow:yt,network:Ut,outline:It,index:B},{group:z,definition:y}}function w(y,B){if(t)return b(y,B);const z=new De,it=[],ht=[],At=[],H=[],Q=new Map,[ct,k,rt]=y.modes,st=40,Et=y.radius*1.8,yt=new kt(y.color),ot=new kt(7439516),Ut=new kt(16774367),A=Array.from({length:18},(U,Y)=>({x:Math.sin(Y*3.71+.8)*.72,y:Math.cos(Y*2.17-.4)*.72,z:Math.sin(Y*1.43+1.9)*.72}));for(let U=0;U<st;U+=1){const Y=U/(st-1)*2-1;for(let $=0;$<st;$+=1){const X=$/(st-1)*2-1;for(let ft=0;ft<st;ft+=1){const lt=ft/(st-1)*2-1;if(Y*Y*.62+X*X*.86+lt*lt*1.16>1.05)continue;const Lt=Y+Math.sin(X*Math.PI*1.4+y.phase)*.1+Math.sin(lt*Math.PI*2.1)*.045,nt=X+Math.sin(lt*Math.PI*1.25-y.phase*.4)*.11-Math.sin(Y*Math.PI*1.8)*.04,dt=lt+Math.sin(Y*Math.PI*1.55+y.phase*.3)*.12+Math.cos(X*Math.PI*1.9)*.04,wt=fm(Lt,nt,dt,ct,k,rt);let Rt=1/0,vt=1/0,zt=1/0;A.forEach(xt=>{const Ot=Lt-xt.x,ie=nt-xt.y,fe=dt-xt.z,Wt=Math.sqrt(Ot*Ot+ie*ie+fe*fe);Wt<Rt?(zt=vt,vt=Rt,Rt=Wt):Wt<vt?(zt=vt,vt=Wt):Wt<zt&&(zt=Wt)});const Ht=Math.exp(-((vt-Rt)**2)*28-(zt-vt)**2*44),Qt=Math.exp(-Math.abs(wt)*4.2),P=Ht*(.56+Qt*.62);if(P<.55)continue;const mt=Math.min(1,P*.72+Qt*.35),q=Math.sin((U*97+$*57+ft*31+B*17)*.19)*.008,j=[(Lt*1.12+nt*.22+nt*dt*.055+q)*Et,(nt*.92+dt*.12+Math.sin(Lt*Math.PI)*.055-q*.4)*Et,(dt*.94+Lt*nt*.07)*Et];it.push(...j),Q.set(U*st*st+$*st+ft,{point:j,filamentScore:P});const Mt=ot.clone().lerp(yt,.56+mt*.28).lerp(Ut,mt*.32);ht.push(Mt.r,Mt.g,Mt.b)}}}Q.forEach(({point:U,filamentScore:Y},$)=>{const X=Math.floor($/(st*st)),ft=$%(st*st),lt=Math.floor(ft/st),gt=ft%st;[[1,0,0],[0,1,0],[0,0,1]].forEach(([Lt,nt,dt])=>{const wt=(X+Lt)*st*st+(lt+nt)*st+gt+dt,Rt=Q.get(wt);Rt&&(At.push(...U,...Rt.point),(Y>.76||Rt.filamentScore>.76)&&H.push(...U,...Rt.point))})}),[{center:[-.72,.86,.14],size:[.52,.18],bend:.18,angle:-.22},{center:[.66,-.72,-.2],size:[.34,.14],bend:-.14,angle:.46}].forEach(U=>{const X=new Map;for(let ft=0;ft<9;ft+=1){const lt=ft/8*2-1;for(let gt=0;gt<24;gt+=1){const Lt=gt/23*2-1;if(Lt*Lt+lt*lt*1.45>1)continue;const nt=Ho(Lt,lt,ct,k),dt=Lt*U.size[0],wt=lt*U.size[1],Rt=Math.cos(U.angle),vt=Math.sin(U.angle),zt=[(U.center[0]+dt*Rt-wt*vt)*Et,(U.center[1]+dt*vt+wt*Rt)*Et,(U.center[2]+nt*U.bend+Lt*Lt*.08)*Et];it.push(...zt),ht.push(yt.r,yt.g,yt.b),X.set(ft*24+gt,zt)}}X.forEach((ft,lt)=>{const gt=Math.floor(lt/24),Lt=lt%24;[[0,1],[1,0]].forEach(([nt,dt])=>{const wt=X.get((gt+nt)*24+Lt+dt);wt&&(At.push(...ft,...wt),H.push(...ft,...wt))})})});const Ct=new se;Ct.setAttribute("position",new Kt(it,3)),Ct.setAttribute("color",new Kt(ht,3));const It=new $e(Ct,new We({size:.065,map:i,color:y.color,transparent:!0,opacity:.045,depthWrite:!1,blending:re,sizeAttenuation:!0}));z.add(It);const pt=new $e(Ct,new We({size:.019,map:i,vertexColors:!0,transparent:!0,opacity:.62,depthWrite:!1,blending:re,sizeAttenuation:!0}));z.add(pt);const Nt=new se;Nt.setAttribute("position",new Kt(At,3));const ut=new xr(Nt,new Bn({color:12242401,transparent:!0,opacity:.24,depthWrite:!1,blending:re}));z.add(ut);const S=new se;S.setAttribute("position",new Kt(H,3));const _=new xr(S,new Bn({color:16119807,transparent:!0,opacity:.2,depthWrite:!1,blending:re}));return z.add(_),z.position.set(...y.position),z.userData={...y,isChladni:!0,pattern:pt,glow:It,network:ut,outline:_,index:B},{group:z,definition:y}}function b(y,B){const z=new De,it=[],ht=[],At=t,H=y.radius*2.35,Q=[[40,150,118],[46,190,200],[70,120,235],[182,206,255],[236,182,92],[230,72,96]],ct=Array.from({length:48},(ot,Ut)=>{const A=Q[Math.min(Q.length-1,Math.floor(Ut/8))],ne=Ut%8/7,Ct=ne*ne*.72,It=.32+ne*.68;return A.map(pt=>Math.min(255,(pt*(1-Ct)+255*Ct)*It)/255)});for(let ot=0;ot<At.length;ot+=6){const Ut=At[ot+3],A=At[ot+4],ne=Ut*A,Ct=At[ot]*H,It=At[ot+1]*H,pt=At[ot+2]*H;it.push(Ct,It,pt);const Nt=ct[Math.min(47,Math.max(0,Math.round(At[ot+5])))]||ct[24],ut=.28+ne*1.05;ht.push(Math.min(1,Nt[0]*ut),Math.min(1,Nt[1]*ut),Math.min(1,Nt[2]*ut))}const k=new se;k.setAttribute("position",new Kt(it,3)),k.setAttribute("color",new Kt(ht,3));const rt=new $e(k,new We({size:.045,map:i,color:14412031,transparent:!0,opacity:.11,depthWrite:!1,blending:re,sizeAttenuation:!0}));z.add(rt);const st=new $e(k,new We({size:.014,map:i,vertexColors:!0,transparent:!0,opacity:.9,depthWrite:!1,blending:re,sizeAttenuation:!0}));z.add(st);const Et=new se;Et.setAttribute("position",new Kt([],3));const yt=new xr(Et,new Bn({color:14477823,transparent:!0,opacity:0,depthWrite:!1,blending:re}));return z.add(yt),z.position.set(...y.position),z.userData={...y,isChladni:!0,pattern:st,glow:rt,network:null,outline:yt,index:B},{group:z,definition:y}}function T(y,B){const z=new De,it=new ui(new In({map:i,color:12504031,transparent:!0,opacity:.16,depthWrite:!1,blending:re}));it.scale.setScalar(y.scale*4.5),z.add(it);const ht=new ui(new In({map:i,color:16054271,transparent:!0,opacity:.86,depthWrite:!1,blending:re}));ht.scale.setScalar(y.scale*1.35),z.add(ht);const At=[];for(let ct=0;ct<11;ct+=1){const k=ct*2.39996323+B*.47,rt=y.scale*(.65+ct%4*.35);At.push(Math.cos(k)*rt,Math.sin(k)*rt*.62,Math.sin(k*1.7)*rt*.35)}const H=new se;H.setAttribute("position",new Kt(At,3));const Q=new $e(H,new We({size:.038,map:i,color:14477047,transparent:!0,opacity:.7,depthWrite:!1,blending:re,sizeAttenuation:!0}));return z.add(Q),z.position.set(...y.position),z.userData={halo:it,core:ht,companions:Q,phase:B*.73},{group:z,definition:y}}function F(){const y=new se;y.setAttribute("position",new Kt(new Array(6).fill(0),3));const B=new Ea(y,new xu({color:13095167,transparent:!0,opacity:.38,dashSize:.085,gapSize:.065,depthWrite:!1}));return B.frustumCulled=!1,B.computeLineDistances(),B}function D(){const y=new De,B=new ui(new In({map:i,color:Es,transparent:!0,opacity:.9,depthWrite:!1,blending:re}));y.add(B);const z=new se,it=new Float32Array(360*3),ht=new Float32Array(360*3),At=[],H=new kt(Es);for(let k=0;k<360;k+=1)At.push({s:k/359*2-1,angle:k*2.39996323,radial:.45+k%5*.1}),ht[k*3]=H.r,ht[k*3+1]=H.g,ht[k*3+2]=H.b;z.setAttribute("position",new Le(it,3)),z.setAttribute("color",new Le(ht,3));const Q=new $e(z,new We({size:.044,map:i,vertexColors:!0,transparent:!0,opacity:.92,depthWrite:!1,blending:re}));y.add(Q);const ct=new De;for(let k=0;k<7;k+=1){const rt=new Ye(new ya(.58,1,40),new Fr({color:Es,transparent:!0,opacity:.12,side:Je,depthWrite:!1,blending:re}));rt.userData.s=k/6*2-1,ct.add(rt)}return y.add(ct),y.visible=!1,y.userData={core:B,particles:Q,rings:ct,meta:At},{group:y,geometry:z,positions:it}}function R(y){const B=vm(y);if(c.group.visible=B.active,!B.active)return;const z=ko(y).nodes,it=B.progress*z.length,ht=Math.min(z.length-1,Math.floor(it)),At=.12+(it-ht)*.76,H=r[z[ht]].group.position,Q=r[z[(ht+1)%z.length]].group.position,ct=new N().subVectors(Q,H),k=H.clone().lerp(Q,C(At)),rt=ct.normalize(),st=new N(0,1,0).cross(rt).normalize();st.lengthSq()<.01&&st.set(1,0,0);const Et=rt.clone().cross(st).normalize();c.group.position.copy(k).addScaledVector(Et,Math.sin(y*19)*.045),c.group.quaternion.setFromUnitVectors(new N(0,0,1),rt),c.userData=c.group.userData,c.group.userData.core.scale.setScalar(B.radius*1.65);const yt=c.geometry.getAttribute("position");c.group.userData.meta.forEach((ot,Ut)=>{const A=ot.s*19-y*34,ne=Math.exp(-ot.s*ot.s*3.2),Ct=Math.sin(A)*B.radius*.58*ne,It=ot.s*B.radius*2.7+Ct,pt=B.radius*(.34+.12*Math.cos(A)),Nt=Math.cos(ot.angle)*pt*ot.radial,ut=Math.sin(ot.angle)*pt*ot.radial;yt.setXYZ(Ut,Nt,ut,It)}),c.group.userData.rings.children.forEach(ot=>{const Ut=ot.userData.s*19-y*34,A=Math.exp(-ot.userData.s*ot.userData.s*2.8);ot.position.z=ot.userData.s*B.radius*2.7+Math.sin(Ut)*B.radius*.58*A,ot.scale.setScalar(B.radius*(.64+.12*Math.cos(Ut))),ot.material.opacity=.05+Math.max(0,Math.cos(Ut))*.22*A,ot.rotation.z=y*.7+ot.userData.s}),yt.needsUpdate=!0}function O(y,B=y){const z=Math.min(Hn,Math.floor(y*Lr)/Lr),it=Math.min(dm-1,Math.floor(z*Lr));it!==d&&(d=it,xm.textContent=mm(z),Mm.textContent=z>=4.3?"纵波位移  ξ(x,t) = A sin(kx - ωt)":"原初光子 · 重子 · 声压峰",Sm.textContent=`${Z(z)} / 00:06.40`);const ht=ko(z),At=new Set(ht.nodes),H=_m(z,ht.nodes,r.length,a.length),Q=new Set(H.main);cn.rotation.x=Math.sin(z*.2)*.018,cn.rotation.y=z*.035,cn.rotation.z=Math.sin(z*.17)*.012,r.forEach(({group:k,definition:rt},st)=>{const Et=At.has(st),yt=Et?1:0,ot=Et?1.18:.9;if(k.scale.lerp(new N(ot,ot,ot),.08),k.position.y=rt.position[1]+Math.sin(y*.32+rt.phase)*.05,k.userData.isChladni){k.rotation.x=.58+Math.sin(B*.52+rt.phase)*.24,k.rotation.y=rt.phase+B*rt.spin*1.15,k.rotation.z=rt.phase*.18+B*rt.spin*.62;const A=rt.boundary==="volume";k.userData.pattern.material.opacity=A?.34+yt*.28:.56+yt*.38,k.userData.glow.material.opacity=A?.02+yt*.055:.08+yt*.2,k.userData.network&&(k.userData.network.material.opacity=A?.16+yt*.16:.1+yt*.2),k.userData.outline.material.opacity=A?.08+yt*.16:.07+yt*.2,k.userData.vertexPoints&&(k.userData.vertexPoints.material.opacity=.58+yt*.36)}else k.rotation.y=rt.phase+B*rt.spin,k.rotation.x=Math.sin(B*.6+rt.phase)*.14,k.userData.halo.material.opacity=.12+yt*.24+Math.sin(B*1.8+rt.phase)*.02,k.userData.mantle.material.opacity=.28+yt*.3,k.userData.core.material.opacity=.6+yt*.32,k.userData.particles.material.opacity=.44+yt*.4,k.userData.ring.material.opacity=.12+yt*.26;const Ut=Q.has(st);l[st].classList.toggle("is-focus",Et&&Ut),l[st].style.opacity=Ut?Et?"1":"0.58":"0"}),a.forEach(({group:k},rt)=>{const st=.82+Math.sin(z*1.35+k.userData.phase)*.18;k.scale.setScalar(st),k.userData.companions.rotation.z=B*(.12+rt%3*.035),k.userData.companions.rotation.y=B*.08+k.userData.phase,k.userData.core.material.opacity=.68+st*.16,k.userData.halo.material.opacity=.08+st*.09,h[rt].style.opacity=rt===H.minor?`${.46+st*.2}`:"0"}),Go.forEach(([k,rt],st)=>{const Et=o[st],yt=r[ht.nodes[k]].group.position,ot=r[ht.nodes[rt]].group.position,Ut=Et.geometry.getAttribute("position");Ut.setXYZ(0,yt.x,yt.y,yt.z),Ut.setXYZ(1,ot.x,ot.y,ot.z),Ut.needsUpdate=!0,Et.material.opacity=Ki.smoothstep(z,.12,.72)*.46,Et.computeLineDistances()}),R(z);const ct=gm(z);Ke.position.x=Math.sin(z*.12)*.28+ct*.035,Ke.position.y=.12+Math.cos(z*.17)*.1,Ke.position.z=12.5-ct*1.1,Ke.lookAt(0,0,0),E()}function E(){r.forEach(({group:y},B)=>{M(y,l[B])}),a.forEach(({group:y},B)=>{M(y,h[B])})}function M(y,B){const z=y.getWorldPosition(new N).project(Ke),it=z.z<1&&z.x>-1.1&&z.x<1.1&&z.y>-1.1&&z.y<1.1;B.style.display=it?"block":"none",it&&(B.style.left=`${(z.x*.5+.5)*100}%`,B.style.top=`${(-z.y*.5+.5)*100}%`)}function C(y){return y*y*(3-2*y)}function Z(y){return`00:${y.toFixed(2).padStart(5,"0")}`}function W(){const y=ha.clientWidth,B=ha.clientHeight,z=Math.min(window.devicePixelRatio||1,2,3840/y,2160/B);zi.setPixelRatio(z),zi.setSize(y,B,!1),Ke.aspect=y/B,Ke.updateProjectionMatrix()}function J(y){f=y,Ar.innerHTML=`<i data-lucide="${y?"pause":"play"}"></i>`,Ar.setAttribute("aria-label",y?"暂停":"播放"),Ar.title=y?"暂停":"播放",Rc({icons:{Play:bc,Pause:Ac,RotateCcw:wc}})}Ar.addEventListener("click",async()=>{if(f){ke.pause(),J(!1);return}ke.currentTime>=Hn-.02&&(ke.currentTime=0),await ke.play(),J(!0)}),Em.addEventListener("click",()=>{ke.pause(),ke.currentTime=0,J(!1),O(0,K)}),ke.addEventListener("timeupdate",()=>{ke.currentTime>=Hn&&(ke.pause(),ke.currentTime=Hn,J(!1))}),window.addEventListener("resize",W),W(),O(0);const tt=new Eu;let K=0;function et(){const y=Math.min(ke.currentTime,Hn);K+=Math.min(tt.getDelta(),.05),O(y,K),zi.render(wa,Ke),requestAnimationFrame(et)}et()}ym();
